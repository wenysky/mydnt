...
namespace Discuz.Toolkit
{
    public class Util
    {
        static Util()
        {
            if (DiscuzCookieContainer == null)
                DiscuzCookieContainer = new CookieContainer();
        }
        private const string LINE = "\r\n";

        public static CookieContainer DiscuzCookieContainer;
        ...
        public static byte[] GetResponseBytes(string apiUrl, string postData)
        {
            ...
            if (DiscuzCookieContainer == null)
                DiscuzCookieContainer = new CookieContainer();
            request.CookieContainer = DiscuzCookieContainer;
