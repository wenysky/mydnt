...
<body>
    ...
    <div style="margin: 30px; text-align: center">
        ...
        <table style="width: 400px; float: left; margin: 10px">
            ...
            <tr>
                <td>
                    读取ID为:<asp:TextBox ID="IDBox" runat="server" Width="30px"></asp:TextBox>用户数据
                </td>
                <td>
            ...
            <tr>
                <td>
                    读取Email为:<asp:TextBox ID="EmailBox1" runat="server" Width="100px"></asp:TextBox>用户数据
                </td>
                <td>
                    <asp:Button ID="ReadBtn1" runat="server" Text="读取" Height="26px" 
                        onclick="ReadBtn1_Click" />
                </td>
            </tr>
            <tr>
                <td>
