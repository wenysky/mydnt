...
namespace Discuz.TestConsole
{
    ...
    public class DiscuzSession
    {
        ...
        public string getInfoByEmail(string email, string fields)
        {
            List<DiscuzParam> param_list = new List<DiscuzParam>();
            ...
            return util.GetResponse("users.getInfoByEmail", param_list.ToArray());
        }
        ...
        /// <returns></returns>
        public string GetList(int fid, int page_size, int page_index, string type_id_list)
        {
            List<DiscuzParam> param_list = new List<DiscuzParam>();
            if (session_info != null && !string.IsNullOrEmpty(session_info.SessionKey))
            {
            ...
            param_list.Add(DiscuzParam.Create("page_index", page_index));
            param_list.Add(DiscuzParam.Create("format", format));
            param_list.Add(DiscuzParam.Create("type_id_list", type_id_list));
        ...
        public string ReplyDelete(string postids, int tid)
        {
            List<DiscuzParam> param_list = new List<DiscuzParam>();
            if (session_info != null && !string.IsNullOrEmpty(session_info.SessionKey))
            {
            ...
            param_list.Add(DiscuzParam.Create("tid", tid));
            return util.GetResponse("topics.deletereplies", param_list.ToArray());
