...
<head>
    <title>Discuz!NT 3.1 API测试 控制台</title>
    <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        methods['Topics.getList'][i++] = 'type_id_list';
        i = 0;
        ...
        i = 0;
        methods['Users.getInfoByEmail'] = [];
        methods['Users.getInfoByEmail'][i++] = 'email';
        methods['Users.getInfoByEmail'][i++] = 'fields';

        var fields = ['uid1', 'uid2', 'uids', 'fields', 'message', 'uid', 'user_info', 'additional_values', 'topic_ids', 'topic_info', 'reply_info', 'fid', 'tid', 'page_size', 'page_index', 'forum_info', 'to_ids', 'notification', 'recipients', 'subject', 'text', 'user_name', 'password', 'email', 'original_password', 'new_password', 'confirm_new_password', 'from_id', 'post_ids','type_id_list'];
    ...
    <div id="iframeRootElementDiv">
        <div id="mainarea">
            <div class="mydev_tabs_header">
                <ul class="tabs">
                    <li class="active">Discuz!NT 3.1 API 测试 控制台</li>
                </ul>
            </div>
            <%if (needlogin)
              {%>
                    ...
                    <tbody>
                        <tr>
                            <td style="width: 180px;" valign="top">
                                ...
                                <div id="method">
                                    ...
                                    <li>
                                        <select name="method" class="t_title" id="method_x" onchange="changeMethod(this)">
                                            ...
                                            <option value="Users.getInfoByEmail">Users.getInfoByEmail</option>
                                ...
                                <div style="display: none;" id="type_id_list">
                                    <li class="title">type_id_list:</li>
                                    <li>
                                        <input class="t_input" name="type_id_list" id="type_id_list_x" value="<%=Util.GetFormString("type_id_list")%>"
                                            type="text" />
                                    </li>
                                </div>
