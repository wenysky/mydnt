...
namespace TestConsoleWeb
{
    public partial class TestConsole : System.Web.UI.Page
    {
        ...
        private string GetResult(string method)
        {
            ...
            if (method == "Users.getInfoByEmail")
            {
                return ds.getInfoByEmail(Util.GetFormString("email"), Util.GetFormString("fields"));
            }
            ...
            {
                return ds.GetList(Util.GetFormInt("fid", 0), Util.GetFormInt("page_size", 1), Util.GetFormInt("page_index", 1), Util.GetString("type_id_list"));
            }
            ...
            if (method == "Topics.deleteReplies")
            {
                return ds.ReplyDelete(Util.GetFormString("post_ids"), Util.GetFormInt("tid", 0));
            }
            ...
            if (method == "Forums.getIndexList")
            {
                return ds.ForumIndexList();
            }
