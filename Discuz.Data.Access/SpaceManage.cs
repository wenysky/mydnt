...
namespace Discuz.Data.Access
{
    public partial class DataProvider : IDataProvider
    {
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@title", (DbType)OleDbType.Char, 50, aci.Title),
                                        DbHelper.MakeInParam("@description", (DbType)OleDbType.Char, 300, aci.Description),
                                        DbHelper.MakeInParam("@displayorder", (DbType)OleDbType.Integer, 4, aci.Displayorder)
                                };
        ...
        public void UpdateAlbumCategory(AlbumCategoryInfo aci)
        {
            DbParameter[] parms = { 
                                        ...
                                        DbHelper.MakeInParam("@description", (DbType)OleDbType.Char, 300, aci.Description),
                                        DbHelper.MakeInParam("@displayorder", (DbType)OleDbType.Integer, 4, aci.Displayorder),
                                        DbHelper.MakeInParam("@albumcateid", (DbType)OleDbType.Integer, 4, aci.Albumcateid)
                                };
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@albumcateid", (DbType)OleDbType.Integer, 4, albumcateid);
        ...
        { 
            ...
            //{
                DbParameter[] prams = {
										   DbHelper.MakeInParam("@spacetitle", (DbType)OleDbType.VarWChar, 100, __spaceconfiginfo.Spacetitle),
										   DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200, __spaceconfiginfo.Description),
										   DbHelper.MakeInParam("@blogdispmode", (DbType)OleDbType.TinyInt, 1, __spaceconfiginfo.BlogDispMode),
										   DbHelper.MakeInParam("@bpp", (DbType)OleDbType.Integer, 4, __spaceconfiginfo.Bpp),
										   DbHelper.MakeInParam("@commentpref", (DbType)OleDbType.TinyInt, 1, __spaceconfiginfo.Commentpref),
										   DbHelper.MakeInParam("@messagepref", (DbType)OleDbType.TinyInt, 1, __spaceconfiginfo.MessagePref),
										   DbHelper.MakeInParam("@rewritename", (DbType)OleDbType.VarChar, 100, __spaceconfiginfo.Rewritename),
										   DbHelper.MakeInParam("@themeid", (DbType)OleDbType.Integer, 4, __spaceconfiginfo.ThemeID),
										   DbHelper.MakeInParam("@themepath", (DbType)OleDbType.VarWChar, 50, __spaceconfiginfo.ThemePath),
                                           //DbHelper.MakeInParam("@status", (DbType)OleDbType.Integer, 4, __spaceconfiginfo.Status),
										   DbHelper.MakeInParam("@updatedatetime", (DbType)OleDbType.Date, 4, DateTime.Now),
										   
										   //DbHelper.MakeInParam("@defaulttab", (DbType)OleDbType.Integer, 4, DateTime.Now),
										   
										   DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4, __spaceconfiginfo.UserID)
									   };
        ...
        public int AddSpaceConfigData(SpaceConfigInfo __spaceconfiginfo)
        {
            ...
            //{
				...
				{
                    DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.UserID),
                    DbHelper.MakeInParam("@spacetitle", (DbType)OleDbType.VarWChar, 50,__spaceconfiginfo.Spacetitle),
                    DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200,__spaceconfiginfo.Description),
                    DbHelper.MakeInParam("@blogdispmode", (DbType)OleDbType.Integer, 1,__spaceconfiginfo.BlogDispMode),
                    DbHelper.MakeInParam("@bpp", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.Bpp),
                    DbHelper.MakeInParam("@commentpref", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.Commentpref),
                    DbHelper.MakeInParam("@messagepref", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.MessagePref),
                    DbHelper.MakeInParam("@rewritename", (DbType)OleDbType.Char, 100,__spaceconfiginfo.Rewritename),
                    DbHelper.MakeInParam("@themeid", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.ThemeID),
                    DbHelper.MakeInParam("@themepath", (DbType)OleDbType.VarWChar, 50,__spaceconfiginfo.ThemePath),
                    DbHelper.MakeInParam("@postcount", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.PostCount),
                    DbHelper.MakeInParam("@commentcount", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.CommentCount),
                    DbHelper.MakeInParam("@visitedtimes", (DbType)OleDbType.Integer, 4,__spaceconfiginfo.VisitedTimes),
                    DbHelper.MakeInParam("@createdatetime", (DbType)OleDbType.DBTimeStamp, 4,__spaceconfiginfo.CreateDateTime),
                    DbHelper.MakeInParam("@updatedatetime", (DbType)OleDbType.DBTimeStamp, 4,__spaceconfiginfo.UpdateDateTime),
					DbHelper.MakeInParam("@status", (DbType)OleDbType.Integer, 4, __spaceconfiginfo.Status),
				};
            ...
            //"VALUES (@userid,@spacetitle,@description,@blogdispmode,@bpp, @commentpref,@messagepref,@rewritename, @themeid," +
            //"@themepath,@postcount,@commentcount,@visitedtimes,@createdatetime, @updatedatetime)");
               // string sql = "select  @@Identity";

                string sqlstring = String.Format("INSERT INTO [" + BaseConfigs.GetTablePrefix + "spaceconfigs] ([userid], [spacetitle], [description], [blogdispmode], [bpp], [commentpref], [messagepref], [rewritename], [themeid], [themepath], [postcount], [commentcount], [visitedtimes], [createdatetime], [updatedatetime]) VALUES (@userid, @spacetitle, @description, @blogdispmode, @bpp, @commentpref, @messagepref, @rewritename, @themeid, @themepath, @postcount, @commentcount, @visitedtimes, '"+__spaceconfiginfo.CreateDateTime+"','"+__spaceconfiginfo.UpdateDateTime+"')");
                int id = 0;
                DbHelper.ExecuteNonQuery(out id, CommandType.Text, sqlstring, prams);
                return id;
                //return   Int32.Parse(DbHelper.ExecuteDataset(CommandType.Text, "select top 1 spaceid from [" + BaseConfigs.GetTablePrefix + "spaceconfigs] order by spaceid desc").Tables[0].Rows[0][0].ToString());
        ...
        public bool CountUserSpaceCommentCountByUserID(int userid, int commentcount)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					DbHelper.MakeInParam("@commentcount", (DbType)OleDbType.Integer, 4,commentcount),
					DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4,userid)
				};
        ...
        public bool AddSpaceComment(SpaceCommentInfo __spacecomments)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					//DbHelper.MakeInParam("@commentid", (DbType)OleDbType.Integer, 4,__spacecomments.CommentID),
					DbHelper.MakeInParam("@postid", (DbType)OleDbType.Integer, 4,__spacecomments.PostID),
					DbHelper.MakeInParam("@author", (DbType)OleDbType.VarWChar, 50,__spacecomments.Author),
					DbHelper.MakeInParam("@email", (DbType)OleDbType.VarWChar, 100,__spacecomments.Email),
					DbHelper.MakeInParam("@url", (DbType)OleDbType.VarWChar, 255,__spacecomments.Url),
					DbHelper.MakeInParam("@ip", (DbType)OleDbType.VarChar, 100,__spacecomments.Ip),
                    //DbHelper.MakeInParam("@postdatetime", (DbType)OleDbType.d, 4,__spacecomments.PostDateTime),
					DbHelper.MakeInParam("@content", (DbType)OleDbType.VarWChar, 0,__spacecomments.Content),
					DbHelper.MakeInParam("@parentid", (DbType)OleDbType.Integer, 4,__spacecomments.ParentID),
                         DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4,__spacecomments.Uid),
                    DbHelper.MakeInParam("@posttitle", (DbType)OleDbType.VarWChar, 60,__spacecomments.PostTitle)
				};
                string sqlstring = String.Format("INSERT INTO [" + BaseConfigs.GetTablePrefix + "spacecomments] ( [postid], [author], [email], [url], [ip], [postdatetime], [content], [parentid], [uid],[posttitle] ) VALUES ( @postid, @author, @email, @url, @ip,#" + __spacecomments.PostDateTime + "#, @content, @parentid, @uid, @posttitle)");
        ...
        public bool SaveSpaceComment(SpaceCommentInfo __spacecomments)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@url", (DbType)OleDbType.VarWChar, 255,__spacecomments.Url),
					DbHelper.MakeInParam("@ip", (DbType)OleDbType.VarChar, 100,__spacecomments.Ip),
					DbHelper.MakeInParam("@postdatetime", (DbType)OleDbType.DBTimeStamp, 4,__spacecomments.PostDateTime),
					DbHelper.MakeInParam("@content", (DbType)OleDbType.VarWChar, 0,__spacecomments.Content),
					DbHelper.MakeInParam("@parentid", (DbType)OleDbType.Integer, 4,__spacecomments.ParentID),
                    DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4,__spacecomments.Uid),
					DbHelper.MakeInParam("@posttitle", (DbType)OleDbType.VarWChar, 60,__spacecomments.PostTitle),
            ...
            try
            {
                ...
                if (currentPage == 1)
                {
                    sql = "SELECT TOP " + pageSize.ToString() + " * FROM "
                        + "[" + BaseConfigs.GetTablePrefix + "spacecomments] WHERE [uid]=@userid ORDER BY [commentid] " + ordertype;
                ...
                else
                {
                    if (!orderbyASC)
                    {
                        sql = "SELECT TOP " + pageSize.ToString() + " * FROM "
                            ...
                            + "[uid]=@userid ORDER BY [commentid] " + ordertype + ") AS tblTmp ) AND [uid]=@userid ORDER BY [commentid] " + ordertype;
                    }
                    else
                    {
                        sql = "SELECT TOP " + pageSize.ToString() + " * FROM "
        ...
        public DataTable GetSpaceCommentListByPostid(int pageSize, int currentPage, int postid, bool orderbyASC)
        {
            try
            {
                DbParameter parm = DbHelper.MakeInParam("@postid", (DbType)OleDbType.Integer, 4, postid);
                string ordertype = orderbyASC ? "ASC" : "DESC";
                int pageTop = (currentPage - 1) * pageSize;
        ...
        public bool AddSpacePost(SpacePostInfo __spaceposts)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@author", (DbType)OleDbType.VarWChar, 20,__spaceposts.Author),
					DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4,__spaceposts.Uid),
                    DbHelper.MakeInParam("@postdatetime", (DbType)OleDbType.DBTimeStamp, 8,__spaceposts.Postdatetime),
					DbHelper.MakeInParam("@content", (DbType)OleDbType.VarWChar, 0,__spaceposts.Content),
					DbHelper.MakeInParam("@title", (DbType)OleDbType.VarWChar, 150,__spaceposts.Title),
					DbHelper.MakeInParam("@category", (DbType)OleDbType.VarChar, 255,__spaceposts.Category),
					DbHelper.MakeInParam("@poststatus", (DbType)OleDbType.Integer, 1,__spaceposts.PostStatus),
					DbHelper.MakeInParam("@commentstatus", (DbType)OleDbType.Integer, 1,__spaceposts.CommentStatus),
                    DbHelper.MakeInParam("@postupdatetime", (DbType)OleDbType.DBTimeStamp, 8,__spaceposts.PostUpDateTime),
					DbHelper.MakeInParam("@commentcount", (DbType)OleDbType.Integer, 4,__spaceposts.Commentcount),
                    //DbHelper.MakeInParam("@postid", (DbType)OleDbType.Integer, 4,__spaceposts.PostID)
				};
                string sqlstring = String.Format("INSERT INTO [" + BaseConfigs.GetTablePrefix + "spaceposts]([author], [uid], [postdatetime], [content], [title], [category], [poststatus], [commentstatus], [postupdatetime], [commentcount]) VALUES (@author,@uid,#" + __spaceposts.Postdatetime + "#,@content,@title,@category,@poststatus,@commentstatus,#" + __spaceposts.PostUpDateTime + "#,@commentcount);");
          ...
          // string  sql = "select  @@Identity";
                    ...
                    __IDataReader = DbHelper.ExecuteReader(CommandType.Text, "select top 1 [postid] from ["+BaseConfigs.GetTablePrefix+"spaceposts] order by postid desc");
               ...
               //DbHelper.MakeInParam("@postupdatetime", (DbType)OleDbType.DBTimeStamp, 8,__spaceposts.PostUpDateTime),
                DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, __spaceposts.Uid)
                    ...
                    sqlstring = "UPDATE [" + BaseConfigs.GetTablePrefix + "spaceconfigs] SET [updatedatetime]=#" + __spaceposts.PostUpDateTime + "# WHERE [userid]=@uid";
                    DbHelper.ExecuteNonQuery(CommandType.Text, sqlstring, prams2);
                ...
                DbParameter[] prams1 = 
				{
					DbHelper.MakeInParam("@spacepostid", (DbType)OleDbType.Integer, 4,__IDataReader[0].ToString()),
					DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4,__spaceposts.Uid)
				};
                __IDataReader.Close();
                //更新与当前日志关联的附件表中的数据
        ...
        public bool SaveSpacePost(SpacePostInfo __spaceposts)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@title", (DbType)OleDbType.VarWChar, 150, __spaceposts.Title),
					DbHelper.MakeInParam("@category", (DbType)OleDbType.VarChar, 255, __spaceposts.Category),
					DbHelper.MakeInParam("@poststatus", (DbType)OleDbType.TinyInt, 1, __spaceposts.PostStatus),
					DbHelper.MakeInParam("@commentstatus", (DbType)OleDbType.TinyInt, 1, __spaceposts.CommentStatus),
                    //DbHelper.MakeInParam("@postupdatetime", (DbType)OleDbType.DBTimeStamp, 8, __spaceposts.PostUpDateTime),
                    //DbHelper.MakeInParam("@commentcount", (DbType)OleDbType.Integer, 4, __spaceposts.CommentCount),
                    DbHelper.MakeInParam("@postid", (DbType)OleDbType.Integer, 4, __spaceposts.Postid)
				};
                string sqlstring = String.Format("UPDATE [" + BaseConfigs.GetTablePrefix + "spaceposts]  SET [author] = @author, [uid] = @uid, [postdatetime] =#" + __spaceposts.Postdatetime + "#, [content] = @content, [title] = @title, [category] = @category, [poststatus] = @poststatus, [commentstatus] = @commentstatus, [postupdatetime] = #" + __spaceposts.PostUpDateTime + "# WHERE [postid] = @postid");
                ...
                sqlstring = "UPDATE [" + BaseConfigs.GetTablePrefix + "spaceconfigs] SET [updatedatetime]=#" + __spaceposts.Postdatetime + "# WHERE [userid]=@uid";
        ...
        {
            IDataReader __IDataReader = DbHelper.ExecuteReader(CommandType.Text, "SELECT * FROM [" + BaseConfigs.GetTablePrefix + "spaceposts] WHERE  [postid]=" + postid);
            return __IDataReader;
        }
        ...
        public DataTable SpacePostsList(int pageSize, int currentPage, int userid)
        {
            ...
            if (currentPage == 1)
            {
                string sql = "SELECT TOP " + pageSize.ToString() + " * FROM "
        ...
        public DataTable SpacePostsList(int pageSize, int currentPage, int userid, int poststatus)
        {
			...
			{
			    DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4, userid),
				DbHelper.MakeInParam("@poststatus", (DbType)OleDbType.Integer, 4, poststatus)
			};
            int pageTop = (currentPage - 1) * pageSize;
            if (currentPage == 1)
            {
        ...
        public int GetSpacePostsCount(int userid, int poststatus,string postdatetime)
        {
            try
            {
                ...
                return int.Parse(DbHelper.ExecuteScalar(CommandType.Text, "SELECT COUNT([postid]) FROM [" + BaseConfigs.GetTablePrefix + "spaceposts] WHERE [uid]=@userid AND [poststatus]=@poststatus AND DATEDIFF(\"d\", @postdatetime, postdatetime) = 0", prams).ToString());
            }
            catch
            {
                return 0;
        ...
        public bool CountUserSpaceViewsByUserID(int postid, int views)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					DbHelper.MakeInParam("@views", (DbType)OleDbType.Integer, 4,views),
					DbHelper.MakeInParam("@postid", (DbType)OleDbType.Integer, 4,postid)
				};
        ...
        public bool AddSpaceCategory(SpaceCategoryInfo __spacecategories)
        {
            ...
            ////{
                DbParameter[] prams = 
                {
                    DbHelper.MakeInParam("@title", (DbType)OleDbType.VarWChar, 50,__spacecategories.Title),
                    DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4,__spacecategories.Uid),
                    DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 1000,__spacecategories.Description),
                    DbHelper.MakeInParam("@typeid", (DbType)OleDbType.Integer, 4,__spacecategories.TypeID),
                    DbHelper.MakeInParam("@categorycount", (DbType)OleDbType.Integer, 4,__spacecategories.CategoryCount),
                    DbHelper.MakeInParam("@displayorder", (DbType)OleDbType.Integer, 4,__spacecategories.Displayorder),
                   //DbHelper.MakeInParam("@categoryid", (DbType)OleDbType.Integer, 4,__spacecategories.CategoryID)
                };
        ...
        public IDataReader GetCategoryNameByUserID(int userid)
        {
            if (userid > 0)
            {
                ...
                IDataReader __IDataReader = DbHelper.ExecuteReader(CommandType.Text, sql);
                return __IDataReader;
            }
            else
            {
        ...
        public bool AddSpacePostCategory(SpacePostCategoryInfo __spacepostcategories)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@postid", (DbType)OleDbType.Integer, 4,__spacepostcategories.PostID),
					DbHelper.MakeInParam("@categoryid", (DbType)OleDbType.Integer, 4,__spacepostcategories.CategoryID),
                    DbHelper.MakeInParam("@id", (DbType)OleDbType.Integer, 4,__spacepostcategories.ID)
				};
        ...
        public bool AddSpaceAttachment(SpaceAttachmentInfo __spaceattachments)
        {
            ...
            //{
                DbParameter[] prams = 
				{
                    //DbHelper.MakeInParam("@aid", (DbType)OleDbType.Integer, 4,__spaceattachments.AID),
					DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4,__spaceattachments.UID),
					DbHelper.MakeInParam("@spacepostid", (DbType)OleDbType.Integer, 4,__spaceattachments.SpacePostID),
					DbHelper.MakeInParam("@postdatetime", (DbType)OleDbType.DBTimeStamp, 8,__spaceattachments.PostDateTime),
					DbHelper.MakeInParam("@filename", (DbType)OleDbType.VarWChar, 100,__spaceattachments.FileName),
					DbHelper.MakeInParam("@filetype", (DbType)OleDbType.VarWChar, 50,__spaceattachments.FileType),
					DbHelper.MakeInParam("@filesize", (DbType)OleDbType.Numeric, 8,__spaceattachments.FileSize),
					DbHelper.MakeInParam("@attachment", (DbType)OleDbType.VarWChar, 100,__spaceattachments.Attachment),
					DbHelper.MakeInParam("@downloads", (DbType)OleDbType.Integer, 4,__spaceattachments.Downloads),
					
				};
                string sqlstring = String.Format("INSERT INTO [" + BaseConfigs.GetTablePrefix + "spaceattachments]( [uid], [spacepostid], [postdatetime], [filename], [filetype], [filesize], [attachment], [downloads]) VALUES ( @uid, " + __spaceattachments.SpacePostID + ",#" + __spaceattachments.PostDateTime + "#,'" + __spaceattachments.FileName + "','" + __spaceattachments.FileType + "'," + __spaceattachments.FileSize + ",'" + __spaceattachments.Attachment + "'," + __spaceattachments.Downloads + ")");
        ...
        public bool SaveSpaceAttachment(SpaceAttachmentInfo __spaceattachments)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@filesize", (DbType)OleDbType.Numeric, 8,__spaceattachments.FileSize),
					DbHelper.MakeInParam("@attachment", (DbType)OleDbType.VarWChar, 100,__spaceattachments.Attachment),
					DbHelper.MakeInParam("@attachment", (DbType)OleDbType.Integer, 4,__spaceattachments.Downloads),
                    DbHelper.MakeInParam("@aid", (DbType)OleDbType.Integer, 4,__spaceattachments.AID)
				};
        ...
        public bool DeleteSpaceAttachmentByIDList(string aidlist, int userid)
        {
            //			DbParameter[] prams = 
            //			{
            //						DbHelper.MakeInParam("@aidlist", (DbType)OleDbType.VarChar, 1000, aidlist)
            //			};
        ...
        public bool SaveSpaceLink(SpaceLinkInfo __spacelinks)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@linktitle", (DbType)OleDbType.VarWChar, 50,__spacelinks.LinkTitle),
					DbHelper.MakeInParam("@linkurl", (DbType)OleDbType.VarChar,255,__spacelinks.LinkUrl),
					DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200,__spacelinks.Description),
                    DbHelper.MakeInParam("@linkid", (DbType)OleDbType.Integer, 4,__spacelinks.LinkId)
				};
        ...
        public bool AddSpaceLink(SpaceLinkInfo __spacelinks)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4,__spacelinks.UserId),
					DbHelper.MakeInParam("@linktitle", (DbType)OleDbType.VarWChar, 50,__spacelinks.LinkTitle),
					DbHelper.MakeInParam("@linkurl", (DbType)OleDbType.VarChar,255,__spacelinks.LinkUrl),
					DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200,__spacelinks.Description),
                    //DbHelper.MakeInParam("@linkid", (DbType)OleDbType.Integer, 4,__spacelinks.LinkId)
        ...
        public IDataReader SpaceAlbumsList(int userid, int albumcategoryid, int pageSize, int currentPage)
        {
           ...
           resql="SELECT * FROM [{0}albums]  WHERE [albumid] IN (SELECT TOP "+pageSize+" [albumid] FROM [{0}albums] "+sql+" ORDER BY [albumid] DESC) ORDER BY [albumid] DESC";
            }
            else
            {


                resql = "SELECT * FROM [{0}albums] WHERE [albumid] IN (SELECT TOP " + pageSize + " [albumid] FROM [{0}albums] " + sql + " AND [albumid] < (SELECT MIN([albumid]) FROM (SELECT TOP " + (currentPage - 1) * pageSize + " [albumid] FROM [{0}albums] " + sql + " ORDER BY [albumid] DESC) AS [ttt]) ORDER BY [albumid] DESC) ORDER BY [albumid] DESC";
        ...
        public int SpaceAlbumsListCount(int userid,int albumcategoryid)
        {
            ...
            DbParameter[] parms = {
                                       ...
                                       DbHelper.MakeInParam("@albumcateid", (DbType)OleDbType.Integer, 4, albumcategoryid)
								   };
            if (userid > 0)
            {
        ...
        public bool AddSpaceAlbum(AlbumInfo spaceAlbum)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4,spaceAlbum.Userid),
                    DbHelper.MakeInParam("@username", (DbType)OleDbType.VarChar, 20, spaceAlbum.Username),
					DbHelper.MakeInParam("@albumcateid", (DbType)OleDbType.Integer, 4,spaceAlbum.Albumcateid),
					DbHelper.MakeInParam("@title", (DbType)OleDbType.VarWChar, 50,spaceAlbum.Title),
					DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200,spaceAlbum.Description),
					DbHelper.MakeInParam("@password", (DbType)OleDbType.VarWChar, 50,spaceAlbum.Password),
					DbHelper.MakeInParam("@type", (DbType)OleDbType.Integer, 8,spaceAlbum.Type)
                    
					//DbHelper.MakeInParam("@creatdatetime", (DbType)OleDbType.DBTimeStamp, 8,spaceAlbum.Createdatetime)
				};
        ...
        public bool SaveSpaceAlbum(AlbumInfo spaceAlbum)
        {
            ...
            //{
                DbParameter[] prams = 
				{
					...
					DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200,spaceAlbum.Description),
					DbHelper.MakeInParam("@password", (DbType)OleDbType.VarWChar, 50,spaceAlbum.Password),
					DbHelper.MakeInParam("@imgcount", (DbType)OleDbType.Integer, 4,spaceAlbum.Imgcount),
					DbHelper.MakeInParam("@logo", (DbType)OleDbType.VarWChar, 255, spaceAlbum.Logo),
					DbHelper.MakeInParam("@type", (DbType)OleDbType.Integer, 8,spaceAlbum.Type),
                    DbHelper.MakeInParam("@albumid", (DbType)OleDbType.Integer, 4, spaceAlbum.Albumid)
				};
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@albumid", (DbType)OleDbType.Integer, 4, albumid);
        ...
        public bool AddSpacePhoto(PhotoInfo photoinfo)
        {
            ...
            DbParameter[] prams = 
				{
					DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4,photoinfo.Userid),
                    DbHelper.MakeInParam("@username", (DbType)OleDbType.VarChar, 20, photoinfo.Username),
					DbHelper.MakeInParam("@title", (DbType)OleDbType.VarWChar, 20,photoinfo.Title),
					DbHelper.MakeInParam("@albumid", (DbType)OleDbType.Integer, 4,photoinfo.Albumid),
					DbHelper.MakeInParam("@filename", (DbType)OleDbType.VarWChar, 255,photoinfo.Filename),
					DbHelper.MakeInParam("@attachment", (DbType)OleDbType.VarWChar, 255,photoinfo.Attachment),
					DbHelper.MakeInParam("@filesize", (DbType)OleDbType.Integer, 4,photoinfo.Filesize),
					DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200,photoinfo.Description),
                    DbHelper.MakeInParam("@isattachment",(DbType)OleDbType.Integer,4,photoinfo.IsAttachment),
                    DbHelper.MakeInParam("@commentstatus", (DbType)OleDbType.Integer, 1, (byte)photoinfo.Commentstatus),
                    DbHelper.MakeInParam("@tagstatus", (DbType)OleDbType.Integer, 1, (byte)photoinfo.Tagstatus)
					//DbHelper.MakeInParam("@creatdatetime", (DbType)OleDbType.DBTimeStamp, 8,spaceAlbum.Createdatetime)
				};
        ...
        public void UpdatePhotoInfo(PhotoInfo photo)
        {
            DbParameter[] parms = { 
                                        ...
                                        DbHelper.MakeInParam("@title", (DbType)OleDbType.VarWChar, 20, photo.Title),
                                        DbHelper.MakeInParam("@description", (DbType)OleDbType.VarWChar, 200, photo.Description),
                                        DbHelper.MakeInParam("@commentstatus", (DbType)OleDbType.TinyInt, 1, (byte)photo.Commentstatus),
                                        DbHelper.MakeInParam("@tagstatus", (DbType)OleDbType.TinyInt, 1, (byte)photo.Tagstatus),
                                        DbHelper.MakeInParam("@photoid", (DbType)OleDbType.Integer, 4, photo.Photoid)
                                    };
        ...
        public DataTable GetSpacePhotoByAlbumID(int albumid)
        {
            DbParameter[] prams = 
				{
					DbHelper.MakeInParam("@albumid", (DbType)OleDbType.Integer, 4,albumid)
				};
            ...
            DbParameter[] prams = 
				{
                    ...
                    DbHelper.MakeInParam("@albumid", (DbType)OleDbType.Integer, 4, albumid),
                    DbHelper.MakeInParam("@photoid", (DbType)OleDbType.Integer, 4,photoid)
				};
            string sqlstring;
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@photoid", (DbType)OleDbType.Integer, 4, photoid);
        ...
        public int GetPhotoSizeByUserid(int userid)
        {
           ...
           // string sql = "SELECT IsNull(SUM(filesize)) AS [filesize] FROM [" + BaseConfigs.GetTablePrefix + "photos] WHERE userid=" + userid;
            string sql = "SELECT IIF(ISNULL(SUM([filesize])),0,SUM([filesize])) AS [filesize]FROM [" + BaseConfigs.GetTablePrefix + "photos] WHERE userid=" + userid;
         
            return Convert.ToInt32((DbHelper.ExecuteScalar(CommandType.Text,sql).ToString()));
        }
        ...
        public IDataReader GetThemeInfoById(int themeId)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@themeid", (DbType)OleDbType.Integer, 4, themeId)
			};
        ...
        public IDataReader GetTemplateInfoById(int templateInfoId)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@templateid", (DbType)OleDbType.Integer, 4, templateInfoId)	
			};
        ...
        public IDataReader GetModuleDefInfoById(int moduleDefInfoId)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@moduledefid", (DbType)OleDbType.Integer, 4, moduleDefInfoId)	
			};
        ...
        public bool AddModuleDef(ModuleDefInfo moduleDefInfo)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@modulename", (DbType)OleDbType.VarWChar, 20, moduleDefInfo.ModuleName),
				DbHelper.MakeInParam("@cachetime", (DbType)OleDbType.Integer, 4, moduleDefInfo.CacheTime),
				DbHelper.MakeInParam("@configfile", (DbType)OleDbType.VarChar, 100, moduleDefInfo.ConfigFile),
				DbHelper.MakeInParam("@controller", (DbType)OleDbType.VarChar, 255, moduleDefInfo.BussinessController),
			};
        ...
        public bool UpdateModuleDef(ModuleDefInfo moduleDefInfo)
        {
            DbParameter[] parms =
			{
				...
				DbHelper.MakeInParam("@configfile", (DbType)OleDbType.VarChar, 100, moduleDefInfo.ConfigFile),
				DbHelper.MakeInParam("@controller", (DbType)OleDbType.VarChar, 255, moduleDefInfo.BussinessController),
                DbHelper.MakeInParam("@moduledefid", (DbType)OleDbType.Integer, 4, moduleDefInfo.ModuleDefID)
			};
        ...
        public bool DeleteModuleDef(int moduleDefId)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@moduledefid", (DbType)OleDbType.Integer, 4, moduleDefId),
			};
        ...
        public int GetModuleDefIdByUrl(string url)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@configfile", (DbType)OleDbType.VarChar, 100, url),
			};
        ...
        public int GetModulesCountByTabId(int tabId, int uid)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@tabid", (DbType)OleDbType.Integer, 4, tabId),
        ...
        public IDataReader GetModuleInfoById(int moduleInfoId, int uid)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@moduleid", (DbType)OleDbType.Integer, 4, moduleInfoId),
				DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, uid)
			};
        ...
        public bool AddModule(ModuleInfo moduleInfo)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@moduleid", (DbType)OleDbType.Integer, 4, moduleInfo.ModuleID),
				DbHelper.MakeInParam("@tabid", (DbType)OleDbType.Integer, 4, moduleInfo.TabID),
				DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, moduleInfo.Uid),
				DbHelper.MakeInParam("@moduledefid", (DbType)OleDbType.Integer, 4, moduleInfo.ModuleDefID),
				DbHelper.MakeInParam("@panename", (DbType)OleDbType.VarChar, 10, moduleInfo.PaneName),
				DbHelper.MakeInParam("@displayorder", (DbType)OleDbType.Integer, 4, moduleInfo.DisplayOrder),
				DbHelper.MakeInParam("@userpref", (DbType)OleDbType.VarWChar, 4000, moduleInfo.UserPref),
				DbHelper.MakeInParam("@val", (DbType)OleDbType.TinyInt, 1, moduleInfo.Val),
				DbHelper.MakeInParam("@moduleurl", (DbType)OleDbType.VarChar, 255, moduleInfo.ModuleUrl),
				DbHelper.MakeInParam("@moduletype", (DbType)OleDbType.TinyInt, 2, moduleInfo.ModuleType)
			};
...
DbHelper.MakeInParam("@moduleid", (DbType)OleDbType.Integer, 4, moduleInfo.ModuleID)
            ...
            string sql = string.Format(@"UPDATE [{0}spacemodules] SET [tabid]=@tabid, [moduledefid]=@moduledefid, [panename]=@panename, [displayorder]=@displayorder,[userpref]=@userpref,[val]=@val, moduleurl=@moduleurl, moduletype=@moduletype WHERE [uid]=@uid AND [moduleid]=@moduleid ", BaseConfigs.GetTablePrefix);
        ...
        public bool DeleteModule(int moduleId, int uid)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@moduleid", (DbType)OleDbType.Integer, 4, moduleId),
				DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, uid)
			};
        ...
        public void UpdateModuleOrder(int mid, int uid, string panename, int displayorder)
        {
            DbParameter[] parms =
			{
				...
				DbHelper.MakeInParam("@panename", (DbType)OleDbType.VarChar, 10, panename),
				DbHelper.MakeInParam("@displayorder", (DbType)OleDbType.Integer, 4, displayorder),
                DbHelper.MakeInParam("@moduleid", (DbType)OleDbType.Integer, 4, mid),
				DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, uid)
			};
        ...
        public IDataReader GetTabInfosByUid(int uid)
        {
            ...
            string sql = string.Format(@"SELECT * FROM [{0}spacetabs] WHERE [uid]=@uid", BaseConfigs.GetTablePrefix);
        ...
        public IDataReader GetTabInfoById(int tabInfoId, int uid)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@tabid", (DbType)OleDbType.Integer, 4, tabInfoId),
				DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, uid)	
			};
        ...
        public bool AddTab(TabInfo tabInfo)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@tabid", (DbType)OleDbType.Integer, 4, tabInfo.TabID),
				DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, tabInfo.UserID),
				DbHelper.MakeInParam("@displayorder", (DbType)OleDbType.Integer, 4, tabInfo.DisplayOrder),
				DbHelper.MakeInParam("@tabname", (DbType)OleDbType.VarWChar, 50, tabInfo.TabName),
				DbHelper.MakeInParam("@iconfile", (DbType)OleDbType.VarChar, 50, tabInfo.IconFile),
				DbHelper.MakeInParam("@template", (DbType)OleDbType.VarChar, 50, tabInfo.Template)
			};
        ...
        public bool SetTabTemplate(int tabid, int uid, string template)
        {
            DbParameter[] parms =
			{
				DbHelper.MakeInParam("@tabid", (DbType)OleDbType.Integer, 4, tabid),
				DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, uid),
				DbHelper.MakeInParam("@template", (DbType)OleDbType.VarChar, 50, template)
			};
        ...
        public void SetSpaceTheme(int userid, int themeid, string themepath)
        {
			...
			{
                DbHelper.MakeInParam("@themeid", (DbType)OleDbType.Integer, 4, themeid),
				DbHelper.MakeInParam("@themepath", (DbType)OleDbType.VarChar, 50, themepath),
                DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4, userid)
			};
        ...
        public DataRow GetThemes()
        {
            ...
            string sql = "SELECT TOP 1 rnd([themeid]) AS row,[themeid],[directory] FROM "+BaseConfigs.GetTablePrefix+"spacethemes WHERE type<>0 ORDER BY 1";
        ...
        { 
            DbParameter parm = DbHelper.MakeInParam("@name", (DbType)OleDbType.VarWChar, 50, name);
        ...
        public bool IsThemeExist(string name, int themeid)
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@name", (DbType)OleDbType.VarWChar, 50, name),
                                    DbHelper.MakeInParam("@id", (DbType)OleDbType.Integer, 4, themeid)
                                };
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@directory", (DbType)OleDbType.VarChar, 100, directory),
                                        DbHelper.MakeInParam("@name", (DbType)OleDbType.VarWChar, 50, name),
                                        DbHelper.MakeInParam("@type", (DbType)OleDbType.Integer, 50, type),
                                        DbHelper.MakeInParam("@author", (DbType)OleDbType.VarWChar, 100, author),
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@themeid", (DbType)OleDbType.Integer, 4, themeid);
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4, pcomment.Userid),
                                        DbHelper.MakeInParam("@username", (DbType)OleDbType.VarWChar, 20, pcomment.Username),
                                        DbHelper.MakeInParam("@photoid", (DbType)OleDbType.Integer, 4, pcomment.Photoid),
                                        DbHelper.MakeInParam("@postdatetime", (DbType)OleDbType.DBTimeStamp, 4, pcomment.Postdatetime),
                                        DbHelper.MakeInParam("@ip", (DbType)OleDbType.VarChar, 100, pcomment.Ip),
                                        DbHelper.MakeInParam("@content", (DbType)OleDbType.VarWChar, 2000, pcomment.Content)
                                    };
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@vaildDays", (DbType)OleDbType.Integer, 4, vaildDays);
            string sql = string.Format("SELECT TOP {0} [p].* FROM [{1}photos] AS [p],[{1}albums] AS [a] WHERE DATEDIFF(\"d\",[p].[postdate],NOW()) <"+vaildDays+" AND [a].[albumid] = [p].[albumid] AND [a].[type]=0",
        ...
        {
            string sql = string.Format("SELECT TOP {0} [p].* FROM [{1}photos] as [p],[{1}albums] as [a] WHERE [a].[albumid] = [p].[albumid] AND [a].[type]=0",
                ...
                case 3:
                    sql = string.Format("SELECT * FROM [{0}albums] WHERE albumid IN (SELECT TOP {1} [tid]"+ 
		                                                                ...
		                                                                " WHERE  [typeid]=1 AND [tid] in (SELECT [albumid]"+ 
                                                                         " FROM [{0}albums] WHERE [type]=0) GROUP BY [tid]"+ 
        ...
        public DataTable GetSpaceList(int pagesize, int currentpage, string username, string dateStart, string dateEnd)
        {
            ...
            if (currentpage == 1)
            {
                string sqlstring = "SELECT TOP " + pagesize.ToString() + " s.[spaceid],[userid],[spacetitle],[username],[grouptitle],[postcount],[commentcount],[createdatetime],[status] ";
        ...
        public void AdminOpenSpaceStatusBySpaceidlist(string spaceidlist)
        {
            ...
            IDataReader idr = DbHelper.ExecuteReader(CommandType.Text, "SELECT [status],[spaceid] from [" + BaseConfigs.GetTablePrefix + "spaceconfigs] WHERE [spaceid] IN (" + spaceidlist + ")");

            while (idr.Read())
            {
                int result = int.Parse(idr["status"].ToString()) & ~ (int)SpaceStatusType.AdminClose;
                DbHelper.ExecuteNonQuery("UPDATE [" + BaseConfigs.GetTablePrefix + "spaceconfigs] SET [status]=" + result + "  WHERE [spaceid]=" + idr["spaceid"].ToString());
        ...
        {
            DbParameter[] parms = {
            DbHelper.MakeInParam("@rewritename", (DbType)OleDbType.Char, 100, rewritename),
            DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4, userid)
            };
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@spaceid", (DbType)OleDbType.Integer, 4, spaceid);
        ...
        public void UpdateCustomizePanelContent(int moduleid, int userid, string modulecontent)
        {
            DbParameter[] parms = {
                DbHelper.MakeInParam("@moduleid", (DbType)OleDbType.Integer, 4, moduleid),                
                DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4, userid),
                DbHelper.MakeInParam("@modulecontent", (DbType)OleDbType.VarWChar, 0, modulecontent)
            };
        ...
        public void AddCustomizePanelContent(int moduleid, int userid, string modulecontent)
        {
            DbParameter[] parms = {
                DbHelper.MakeInParam("@moduleid", (DbType)OleDbType.Integer, 4, moduleid),
                DbHelper.MakeInParam("@userid", (DbType)OleDbType.Integer, 4, userid),
                DbHelper.MakeInParam("@modulecontent", (DbType)OleDbType.VarChar, 0, modulecontent)
            };
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@modulename", (DbType)OleDbType.VarChar, 20, mdi.ModuleName),
                                        DbHelper.MakeInParam("@cachetime", (DbType)OleDbType.Integer, 4, mdi.CacheTime),
                                        DbHelper.MakeInParam("@configfile", (DbType)OleDbType.VarChar, 100, mdi.ConfigFile),
                                        DbHelper.MakeInParam("@controller", (DbType)OleDbType.VarChar, 255, mdi.BussinessController)
            };
        ...
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@validDays", (DbType)OleDbType.Integer, 4, validDays),
                                    DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, uid)
                               };
            string sql = string.Format("SELECT TOP {0} [p].* FROM [{1}photos] [p],[{1}albums] [a] WHERE DATEDIFF(\"d\",NOW(), [postdate]) < @validDays AND [a].[albumid] = [p].[albumid] AND [a].[type]=0{2}",
