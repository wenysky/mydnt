...
namespace Discuz.Data.Access
{
    public partial class DataProvider : IDataProvider
    {
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@alloweditpost",(DbType)OleDbType.Integer,1,admingroupsInfo.Alloweditpost),
									   DbHelper.MakeInParam("@alloweditpoll",(DbType)OleDbType.Integer,1,admingroupsInfo.Alloweditpoll),
									   DbHelper.MakeInParam("@allowstickthread",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowstickthread),
									   DbHelper.MakeInParam("@allowmodpost",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowmodpost),
									   DbHelper.MakeInParam("@allowdelpost",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowdelpost),
									   DbHelper.MakeInParam("@allowmassprune",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowmassprune),
									   DbHelper.MakeInParam("@allowrefund",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowrefund),
									   DbHelper.MakeInParam("@allowcensorword",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowcensorword),
									   DbHelper.MakeInParam("@allowviewip",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowviewip),
									   DbHelper.MakeInParam("@allowbanip",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowbanip),
									   DbHelper.MakeInParam("@allowedituser",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowedituser),
									   DbHelper.MakeInParam("@allowmoduser",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowmoduser),
									   DbHelper.MakeInParam("@allowbanuser",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowbanuser),
									   DbHelper.MakeInParam("@allowpostannounce",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowpostannounce),
									   DbHelper.MakeInParam("@allowviewlog",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowviewlog),
									   DbHelper.MakeInParam("@disablepostctrl",(DbType)OleDbType.Integer,1,admingroupsInfo.Disablepostctrl),
                                       DbHelper.MakeInParam("@allowviewrealname",(DbType)OleDbType.Integer,1,admingroupsInfo.Allowviewrealname),
                                       DbHelper.MakeInParam("@admingid",(DbType)OleDbType.Integer,2,admingroupsInfo.Admingid)
								   };

                                string sql = "UPDATE "+BaseConfigs.GetTablePrefix+@"admingroups SET 
        ...
        public int CreateAdminGroupInfo(AdminGroupInfo admingroupsInfo)
        {
            ...
            string sql = @"INSERT INTO "+BaseConfigs.GetTablePrefix+@"admingroups 
	...
	(@admingid,@alloweditpost,@alloweditpoll,@allowstickthread,@allowmodpost,@allowdelpost,@allowmassprune,@allowrefund,@allowcensorword,@allowviewip,@allowbanip,@allowedituser,@allowmoduser,@allowbanuser,@allowpostannounce,@allowviewlog,@disablepostctrl,@allowviewrealname)";
        ...
        public int CreateFavorites(int uid, int tid, byte type)
        {
            ...
            DbParameter[] prams = {
									   DbHelper.MakeInParam("@uid",(DbType)OleDbType.Integer,4,uid),
									   DbHelper.MakeInParam("@tid",(DbType)OleDbType.Integer,4,tid),
                                       DbHelper.MakeInParam("@type", (DbType)OleDbType.UnsignedTinyInt, 4, type)
								   };
        ...
        public int DeleteFavorites(int uid, string fidlist, byte type)
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer,4, uid),
                                       DbHelper.MakeInParam("@typeid", (DbType)OleDbType.Integer, 1, type)
			                        };
            ...
            switch (typeid)
            {
                case 1:
                    ...
                    if (pageindex == 1)
                    {
                        ...
                        sql = "SELECT TOP " + pagesize + " [tid], [uid], [albumid], [albumcateid], [posterid], [poster], [title], [description], [logo], [password], [imgcount], [views], [type], [postdatetime]  FROM (SELECT [f].[tid], [f].[uid], [albumid], [albumcateid], [userid] AS [posterid], [username] AS [poster], [title], [description], [logo], [password], [imgcount], [views], [type], [createdatetime] AS [postdatetime] FROM [" + BaseConfigs.GetTablePrefix + "favorites] [f],[" + BaseConfigs.GetTablePrefix + "albums] [albums] WHERE [f].[tid]=[albums].[albumid] AND [f].[typeid]=1 AND [f].[uid]=" + uid + ") f ORDER BY [tid] DESC";
                    }
                    else
                    {
                        sql = "SELECT TOP  " + pagesize + " [tid], [uid], [albumid], [albumcateid], [posterid], [poster], [title], [description], [logo], [password], [imgcount], [views], [type], [postdatetime]  FROM (SELECT [f].[tid], [f].[uid], [albumid], [albumcateid], [userid] AS [posterid], [username] AS [poster], [title], [description], [logo], [password], [imgcount], [views], [type], [createdatetime] AS [postdatetime] FROM [" + BaseConfigs.GetTablePrefix + "favorites] [f],[" + BaseConfigs.GetTablePrefix + "albums] [albums] WHERE [f].[tid]=[albums].[albumid] AND [f].[typeid]=1 AND [f].[uid]=" + uid + ") f1 WHERE [tid] < (SELECT MIN([tid]) FROM (SELECT TOP  " + (pageindex - 1) * pagesize + "  [tid] FROM (SELECT [f].[tid], [f].[uid], [albumid], [albumcateid], [userid] AS [posterid], [username] AS [poster], [title], [description], [logo], [password], [imgcount], [views], [type], [createdatetime] AS [postdatetime] FROM [" + BaseConfigs.GetTablePrefix + "favorites] [f],[" + BaseConfigs.GetTablePrefix + "albums] [albums] WHERE [f].[tid]=[albums].[albumid] AND [f].[typeid]=1 AND [f].[uid]=" + uid + ") f2 ORDER BY [tid] DESC) AS tblTmp)  ORDER BY [tid] DESC";
                    }
                    break;
                ...
                case 2:
                    ...
                    if (pageindex == 1)
                    {
                        sql = "SELECT TOP " + pagesize + " [tid], [postid], [poster], [posterid], [uid], [postdatetime], [title], [category], [poststatus], [commentstatus], [postupdatetime], [commentcount], [views]  FROM (" + tempstring0 + ") f ORDER BY [tid] DESC";
                    }
                    else
                    {
                        sql = "SELECT TOP  " + pagesize + " [tid], [postid], [poster], [posterid], [uid], [postdatetime], [title], [category], [poststatus], [commentstatus], [postupdatetime], [commentcount], [views]  FROM ( " + tempstring0 + " ) f1 WHERE [tid] < (SELECT MIN([tid]) FROM (SELECT TOP " + (pageindex - 1) * pagesize + "  [tid] FROM (" + tempstring0 + ") f2 ORDER BY [tid] DESC) AS tblTmp) ORDER BY [tid] DESC";
                ...
                default:
                    string tempstring1 = "";
                    tempstring1 = "SELECT [f].[uid],[f].[tid],[topics].[title],[topics].[poster],[topics].[postdatetime],[topics].[replies],[topics].[views],[topics].[posterid] FROM [" + BaseConfigs.GetTablePrefix + "favorites] [f],[" + BaseConfigs.GetTablePrefix + "topics] [topics] WHERE [f].[tid]=[topics].[tid] AND [f].[typeid]=0 AND [f].[uid]=" + uid + "";

                    if (pageindex == 1)
                    {
                        sql = "SELECT TOP  " + pagesize + " [uid],[tid],[title],[poster],[postdatetime],[replies],[views],[posterid]  FROM (" + tempstring1 + ") f ORDER BY [tid] DESC";
                    }
                    else
                    {
                        sql = "SELECT TOP  " + pagesize + " [uid],[tid],[title],[poster],[postdatetime],[replies],[views],[posterid]  FROM (" + tempstring1 + ") f1 WHERE [tid] < (SELECT MIN([tid]) FROM (SELECT TOP " + (pageindex - 1) * pagesize + " [tid] FROM (" + tempstring1 + ") f2 ORDER BY [tid] DESC) AS tblTmp)  ORDER BY [tid] DESC";
        ...
        public int GetFavoritesCount(int uid, int typeid)
        {
            //DbParameter[] parms = {
            //                           DbHelper.MakeInParam("@uid",(DbType)OleDbType.Integer,4,uid),
            //                           DbHelper.MakeInParam("@typeid",(DbType)OleDbType.Integer,1,typeid)
            //                       };
        ...
        public int CheckFavoritesIsIN(int uid, int tid, byte type)
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@tid",(DbType)OleDbType.Integer,4,tid),
									   DbHelper.MakeInParam("@uid",(DbType)OleDbType.Integer,4,uid),
                                       DbHelper.MakeInParam("@type", (DbType)OleDbType.Integer, 1, type)
			};
        ...
        public void UpdateUserShortInfo(string location, string bio, string signature, int uid)
        {
            ...
            DbParameter[] parms ={
                                        ...
                                        DbHelper.MakeInParam("@location",(DbType)OleDbType.VarWChar,50,location),
                                        DbHelper.MakeInParam("@bio",(DbType)OleDbType.VarWChar,50,bio),
                                        DbHelper.MakeInParam("@uid",(DbType)OleDbType.Integer,4,uid)
        ...
        public void UpdateUserField(UserInfo userinfo, string signature, string authstr, string sightml)
        {
            ...
            DbParameter[] prams1 = {
				...
				DbHelper.MakeInParam("@authflag", (DbType)OleDbType.Integer, 1, 1),
        ...
        {
            DbParameter[] parms = { DbHelper.MakeInParam("@fid", (DbType)OleDbType.Integer, 4, fid) };
        ...
        public int CreateOnlineTable()
        {
            ...
            using (OleDbTransaction trans = conn.BeginTransaction())
            {
                ...
                try
                {
                    ...
                    sb.Append("[newpms] integer Default 0 not null ,");
                    sb.Append("[newnotices] integer Default 0 not null ,");
        ...
        public int DeleteRowsByIP(string ip)
        {
            ...
            DbHelper.ExecuteNonQuery(CommandType.Text, "UPDATE [" + BaseConfigs.GetTablePrefix + "users] SET [onlinestate]=0,[lastactivity]=NOW() WHERE [uid] IN (SELECT [userid] FROM [" + BaseConfigs.GetTablePrefix + "online] WHERE [userid]>0 AND [ip]=@ip)", parms);
            if (ip != "0.0.0.0")
            {
        ...
        public IDataReader GetPrivateMessageList(int userid, int folder, int pagesize, int pageindex, int inttype)
        {
            ...
            if (pageindex == 1)
            {
                if (strwhere != "")
                {
                    strsql = "SELECT TOP  " + pagesize + " [pmid],[msgfrom],[msgfromid],[msgto],[msgtoid],[folder],[new],[subject],[postdatetime],[message] FROM [" + BaseConfigs.GetTablePrefix + "pms] WHERE [" + msgformortoid + "]= " + userid + "  AND [folder]= " + folder + "  AND  " + strwhere + " ORDER BY [pmid] DESC";
                }
                else
                {
                    strsql = "SELECT TOP  " + pagesize + " [pmid],[msgfrom],[msgfromid],[msgto],[msgtoid],[folder],[new],[subject],[postdatetime],[message] FROM [" + BaseConfigs.GetTablePrefix + "pms] WHERE [" + msgformortoid + "]= " + userid + "  AND [folder]= " + folder + "  ORDER BY [pmid] DESC";
            ...
            {
                strsql = "SELECT TOP " + pagesize + " [pmid],[msgfrom],[msgfromid],[msgto],[msgtoid],[folder],[new],[subject],[postdatetime],[message] FROM [" + BaseConfigs.GetTablePrefix + "pms] WHERE [pmid] < (SELECT MIN([pmid]) FROM (SELECT TOP " + (pageindex - 1) * pagesize + "  [pmid] FROM [" + BaseConfigs.GetTablePrefix + "pms] WHERE [" + msgformortoid + "]=" + userid + "  AND [folder]=" + folder + " ORDER BY [pmid] DESC) AS tblTmp) AND [" + msgformortoid + "]=" + userid + " AND [folder]= " + folder + "   ORDER BY [pmid] DESC";
                if (strwhere != "")
                {
                    strsql = "SELECT TOP  " + pagesize + " + [pmid],[msgfrom],[msgfromid],[msgto],[msgtoid],[folder],[new],[subject],[postdatetime],[message] FROM [" + BaseConfigs.GetTablePrefix + "pms] WHERE [pmid] < (SELECT MIN([pmid]) FROM (SELECT TOP " + (pageindex - 1) * pagesize + " +  [pmid] FROM [" + BaseConfigs.GetTablePrefix + "pms] WHERE [" + msgformortoid + "]=" + userid + "  AND [folder]= " + folder + "  AND  " + strwhere + " ORDER BY [pmid] DESC) AS tblTmp) AND [" + msgformortoid + "]= " + userid + "  AND [folder]= " + folder + "  AND  " + strwhere + "  ORDER BY [pmid] DESC";
                }

            }


            return DbHelper.ExecuteReader(CommandType.Text, strsql);
        }
        ...
        public int SetPrivateMessageState(int pmid, byte state)
        {
            ...
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@state",(DbType)OleDbType.Integer,1,state)
								   };
        ...
        public bool CheckUserCreditsIsEnough(int uid, DataRow values, int pos, int mount)
        {
            ...
            String CommandText = "SELECT count(1) FROM [" + BaseConfigs.GetTablePrefix + "users] WHERE [uid]=@uid AND"
                    + "	[extcredits1]>= iif(@extcredits1>=0,abs(@extcredits1),0) AND "
                    + "	[extcredits2]>= iif(@extcredits2>=0,abs(@extcredits2),0) AND "
                    + "	[extcredits3]>= iif(@extcredits3>=0,abs(@extcredits3),0) AND "
                    + "	[extcredits4]>= iif(@extcredits4>=0,abs(@extcredits4),0) AND "
                    + "	[extcredits5]>= iif(@extcredits5>=0,abs(@extcredits5),0) AND "
                    + "	[extcredits6]>= iif(@extcredits6>=0,abs(@extcredits6),0) AND "
                    + "	[extcredits7]>= iif(@extcredits7>=0,abs(@extcredits7),0) AND "
                    + "	[extcredits8]>= iif(@extcredits8>=0,abs(@extcredits8),0)";
        ...
        public IDataReader GetUserTodayRate(int uid)
        {
            ...
            return DbHelper.ExecuteReader(CommandType.Text, "SELECT [extcredits], SUM(ABS([score])) AS [todayrate] FROM [" + BaseConfigs.GetTablePrefix + "ratelog] WHERE DATEDIFF(\"d\",[postdatetime],NOW()) = 0 AND [uid] = @uid GROUP BY [extcredits]", parms);
        }
...
"FROM " + BaseConfigs.GetTablePrefix + "users LEFT JOIN " + BaseConfigs.GetTablePrefix + "userfields ON [" + BaseConfigs.GetTablePrefix + "users].[uid]=[" + BaseConfigs.GetTablePrefix + "userfields].[uid] WHERE [" + BaseConfigs.GetTablePrefix + "users].[uid]=" + uid;
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@uname", (DbType)OleDbType.VarWChar,20, uname)
			};
        ...
        public IDataReader GetShortUserInfoToReader(int uid)
        {
            ...
            return DbHelper.ExecuteReader(CommandType.Text, "SELECT TOP 1 * FROM [" + BaseConfigs.GetTablePrefix + "users] WHERE [" + BaseConfigs.GetTablePrefix + "users].[uid]=@uid", prams);
        ...
        public IDataReader CheckEmailAndSecques(string username, string email, string secques)
        {
            ...
            String sqlstring = "SELECT TOP 1 [uid] FROM [" + BaseConfigs.GetTablePrefix + "users] WHERE [username]=@username AND [email]=@email AND [secques]=@secques";
        ...
        public IDataReader CheckPasswordAndSecques(string username, string password, bool originalpassword, string secques)
        {
            ...
            return DbHelper.ExecuteReader(CommandType.Text, "SELECT TOP 1 [uid] FROM [" + BaseConfigs.GetTablePrefix + "users] WHERE [username]=@username AND [password]=@password AND [secques]=@secques", prams);
        }
        ...
        public IDataReader CheckPassword(string username, string password, bool originalpassword)
        {
            ...
            return DbHelper.ExecuteReader(CommandType.Text, "SELECT TOP 1 [uid] FROM [" + BaseConfigs.GetTablePrefix + "users] WHERE [username]=@username AND [password]=@password", prams);
        }
        ...
        public IDataReader CheckPassword(int uid, string password, bool originalpassword)
        {
            ...
            String sql = "";
            sql = "SELECT TOP 1 [uid], [groupid], [adminid] FROM [" + BaseConfigs.GetTablePrefix + "users] WHERE [uid]=@uid AND [password]=@password";
        ...
        public int CreateUser(UserInfo userinfo)
        {
            ...
            DbParameter[] prams = {
										 ...
										 DbHelper.MakeInParam("@gender",(DbType)OleDbType.Integer,4,userinfo.Gender),
										 DbHelper.MakeInParam("@adminid",(DbType)OleDbType.Integer,4,userinfo.Adminid),
										 DbHelper.MakeInParam("@groupid",(DbType)OleDbType.SmallInt,2,userinfo.Groupid),
										 DbHelper.MakeInParam("@groupexpiry",(DbType)OleDbType.Integer,4,userinfo.Groupexpiry),
										 DbHelper.MakeInParam("@extgroupids",(DbType)OleDbType.Char,60,userinfo.Extgroupids),
										 DbHelper.MakeInParam("@regip",(DbType)OleDbType.VarChar,0,userinfo.Regip),
										 DbHelper.MakeInParam("@joindate",(DbType)OleDbType.VarChar,0,userinfo.Joindate),
										 ...
										 DbHelper.MakeInParam("@lastposttitle",(DbType)OleDbType.VarChar,0,userinfo.Lastposttitle),
										 DbHelper.MakeInParam("@posts",(DbType)OleDbType.Integer,4,userinfo.Posts),
										 DbHelper.MakeInParam("@digestposts",(DbType)OleDbType.SmallInt,2,userinfo.Digestposts),
										 DbHelper.MakeInParam("@oltime",(DbType)OleDbType.SmallInt,2,userinfo.Oltime),
										 DbHelper.MakeInParam("@pageviews",(DbType)OleDbType.Integer,4,userinfo.Pageviews),
										 DbHelper.MakeInParam("@credits",(DbType)OleDbType.Integer,4,userinfo.Credits),
										 DbHelper.MakeInParam("@extcredits1",(DbType)OleDbType.Double,8,userinfo.Extcredits1),
										 DbHelper.MakeInParam("@extcredits2",(DbType)OleDbType.Double,8,userinfo.Extcredits2),
										 DbHelper.MakeInParam("@extcredits3",(DbType)OleDbType.Double,8,userinfo.Extcredits3),
										 DbHelper.MakeInParam("@extcredits4",(DbType)OleDbType.Double,8,userinfo.Extcredits4),
										 DbHelper.MakeInParam("@extcredits5",(DbType)OleDbType.Double,8,userinfo.Extcredits5),
										 DbHelper.MakeInParam("@extcredits6",(DbType)OleDbType.Double,8,userinfo.Extcredits6),
										 DbHelper.MakeInParam("@extcredits7",(DbType)OleDbType.Double,8,userinfo.Extcredits7),
										 DbHelper.MakeInParam("@extcredits8",(DbType)OleDbType.Double,8,userinfo.Extcredits8),
										 DbHelper.MakeInParam("@avatarshowid",(DbType)OleDbType.Integer,4,userinfo.Avatarshowid),
										 DbHelper.MakeInParam("@email",(DbType)OleDbType.Char,50,userinfo.Email),
										 DbHelper.MakeInParam("@bday",(DbType)OleDbType.VarChar,0,userinfo.Bday),
										 DbHelper.MakeInParam("@sigstatus",(DbType)OleDbType.Integer,4,userinfo.Sigstatus),
										 DbHelper.MakeInParam("@tpp",(DbType)OleDbType.Integer,4,userinfo.Tpp),
										 DbHelper.MakeInParam("@ppp",(DbType)OleDbType.Integer,4,userinfo.Ppp),
										 DbHelper.MakeInParam("@templateid",(DbType)OleDbType.SmallInt,2,userinfo.Templateid),
										 DbHelper.MakeInParam("@pmsound",(DbType)OleDbType.Integer,4,userinfo.Pmsound),
										 DbHelper.MakeInParam("@showemail",(DbType)OleDbType.Integer,4,userinfo.Showemail),
										 DbHelper.MakeInParam("@newsletter",(DbType)OleDbType.Integer,4,userinfo.Newsletter),
										 DbHelper.MakeInParam("@invisible",(DbType)OleDbType.Integer,4,userinfo.Invisible),
            ...
            DbParameter[] prams2 = {
									   //
										...
										DbHelper.MakeInParam("@customstatus",(DbType)OleDbType.VarChar,30,userinfo.Customstatus),
										DbHelper.MakeInParam("@avatar",(DbType)OleDbType.VarChar,255,userinfo.Avatar),
										DbHelper.MakeInParam("@avatarwidth",(DbType)OleDbType.Integer,4,(userinfo.Avatarwidth == 0)? 60 : userinfo.Avatarwidth),
										DbHelper.MakeInParam("@avatarheight",(DbType)OleDbType.Integer,4,(userinfo.Avatarheight == 0)? 60 : userinfo.Avatarheight),
										DbHelper.MakeInParam("@medals",(DbType)OleDbType.VarChar,40, userinfo.Medals),
										DbHelper.MakeInParam("@bio",(DbType)OleDbType.VarWChar,0,userinfo.Bio),
										DbHelper.MakeInParam("@signature",(DbType)OleDbType.VarWChar,0,userinfo.Signature),
										DbHelper.MakeInParam("@sightml",(DbType)OleDbType.VarWChar,0,userinfo.Sightml),
										DbHelper.MakeInParam("@authstr",(DbType)OleDbType.VarChar,20,userinfo.Authstr),
                                        DbHelper.MakeInParam("@realname",(DbType)OleDbType.VarWChar,10,userinfo.Realname),
                                        DbHelper.MakeInParam("@idcard",(DbType)OleDbType.VarChar,20,userinfo.Idcard),
                                        DbHelper.MakeInParam("@mobile",(DbType)OleDbType.VarChar,20,userinfo.Mobile),
            ...
            using (OleDbTransaction trans = conn.BeginTransaction())
            {
                try
                {
                    ...
                    sqlstring = "INSERT INTO [" + BaseConfigs.GetTablePrefix + "userfields] ([uid],[website],[icq],[qq],[yahoo],[msn],[skype],[location],[customstatus],[avatar],[avatarwidth],[avatarheight],[medals],[bio],[signature],[sightml],[authstr],[realname],[idcard],[mobile],[phone]) VALUES (" + uid +
                        ",@website,@icq,@qq,@yahoo,@msn,@skype,@location,@customstatus,@avatar,@avatarwidth,@avatarheight,@medals,@bio,@signature,@sightml,@authstr,@realname,@idcard,@mobile,@phone)";
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@username",(DbType)OleDbType.VarWChar,20,userinfo.Username),
									   DbHelper.MakeInParam("@nickname",(DbType)OleDbType.VarWChar,20,userinfo.Nickname),
									   DbHelper.MakeInParam("@password",(DbType)OleDbType.Char,32,userinfo.Password),
									   DbHelper.MakeInParam("@secques",(DbType)OleDbType.Char,8,userinfo.Secques),
									   DbHelper.MakeInParam("@spaceid",(DbType)OleDbType.Integer,4,userinfo.Spaceid),
									   DbHelper.MakeInParam("@gender",(DbType)OleDbType.Integer,4,userinfo.Gender),
									   DbHelper.MakeInParam("@adminid",(DbType)OleDbType.Integer,4,userinfo.Adminid),
									   DbHelper.MakeInParam("@groupid",(DbType)OleDbType.Integer,2,userinfo.Groupid),
									   DbHelper.MakeInParam("@groupexpiry",(DbType)OleDbType.VarWChar,50,userinfo.Groupexpiry),
									   DbHelper.MakeInParam("@extgroupids",(DbType)OleDbType.Char,60,userinfo.Extgroupids),
									   DbHelper.MakeInParam("@regip",(DbType)OleDbType.Char,15,userinfo.Regip),
									   DbHelper.MakeInParam("@joindate",(DbType)OleDbType.Char,19,userinfo.Joindate),
									   DbHelper.MakeInParam("@lastip",(DbType)OleDbType.Char,15,userinfo.Lastip),
									   DbHelper.MakeInParam("@lastvisit",(DbType)OleDbType.Char,19,userinfo.Lastvisit),
									   DbHelper.MakeInParam("@lastactivity",(DbType)OleDbType.Char,19,userinfo.Lastactivity),
									   DbHelper.MakeInParam("@lastpost",(DbType)OleDbType.Char,19,userinfo.Lastpost),
									   DbHelper.MakeInParam("@lastpostid",(DbType)OleDbType.Integer,4,userinfo.Lastpostid),
									   DbHelper.MakeInParam("@lastposttitle",(DbType)OleDbType.VarWChar,60,userinfo.Lastposttitle),
									   DbHelper.MakeInParam("@posts",(DbType)OleDbType.Integer,4,userinfo.Posts),
									   DbHelper.MakeInParam("@digestposts",(DbType)OleDbType.Integer,2,userinfo.Digestposts),
									   DbHelper.MakeInParam("@oltime",(DbType)OleDbType.Integer,2,userinfo.Oltime),
									   DbHelper.MakeInParam("@pageviews",(DbType)OleDbType.Integer,4,userinfo.Pageviews),
									   ...
									   DbHelper.MakeInParam("@avatarshowid",(DbType)OleDbType.Integer,4,userinfo.Avatarshowid),
									   DbHelper.MakeInParam("@email",(DbType)OleDbType.Char,50,userinfo.Email),
									   DbHelper.MakeInParam("@bday",(DbType)OleDbType.Char,19,userinfo.Bday),
									   DbHelper.MakeInParam("@sigstatus",(DbType)OleDbType.Integer,4,userinfo.Sigstatus),
									   DbHelper.MakeInParam("@tpp",(DbType)OleDbType.Integer,4,userinfo.Tpp),
									   DbHelper.MakeInParam("@ppp",(DbType)OleDbType.Integer,4,userinfo.Ppp),
									   DbHelper.MakeInParam("@templateid",(DbType)OleDbType.Integer,2,userinfo.Templateid),
									   ...
									   DbHelper.MakeInParam("@invisible",(DbType)OleDbType.Integer,4,userinfo.Invisible),
									   DbHelper.MakeInParam("@newpm",(DbType)OleDbType.Integer,4,userinfo.Newpm),
									   DbHelper.MakeInParam("@newpmcount",(DbType)OleDbType.Integer,4,userinfo.Newpmcount),
									   DbHelper.MakeInParam("@accessmasks",(DbType)OleDbType.Integer,4,userinfo.Accessmasks),
									   DbHelper.MakeInParam("@onlinestate",(DbType)OleDbType.Integer,4,userinfo.Onlinestate),
                                        DbHelper.MakeInParam("@uid",(DbType)OleDbType.Integer,4,userinfo.Uid)
            ...
            string updatyeuser=@"UPDATE ["+BaseConfigs.GetTablePrefix+@"users] SET [username]=@username,[nickname]=@nickname, [password]=@password, [secques]=@secques, [spaceid]=@spaceid, [gender]=@gender, [adminid]=@adminid, [groupid]=@groupid, [groupexpiry]=@groupexpiry, 
...
WHERE [uid]=@uid";
            DbHelper.ExecuteNonQuery(CommandType.Text, updatyeuser, parms);
            ...
            DbParameter[] parms1 = { 
									   ...
									   DbHelper.MakeInParam("@authstr",(DbType)OleDbType.VarChar,20,userinfo.Authstr),
									   DbHelper.MakeInParam("@authtime",(DbType)OleDbType.DBTimeStamp,4,userinfo.Authtime),
									   DbHelper.MakeInParam("@authflag",(DbType)OleDbType.Integer,1,userinfo.Authflag),
                                       DbHelper.MakeInParam("@realname",(DbType)OleDbType.VarWChar,10,userinfo.Realname),
                                       DbHelper.MakeInParam("@idcard",(DbType)OleDbType.VarChar,20,userinfo.Idcard),
                                       DbHelper.MakeInParam("@mobile",(DbType)OleDbType.VarChar,20,userinfo.Mobile),
                                       DbHelper.MakeInParam("@phone",(DbType)OleDbType.VarChar,20,userinfo.Phone),
                                       DbHelper.MakeInParam("@ignorepm",(DbType)OleDbType.VarWChar,1000,userinfo.Ignorepm),
                                       DbHelper.MakeInParam("@uid",(DbType)OleDbType.Integer,4,userinfo.Uid)
                                   };
            string updatyeuserfields = @"UPDATE ["+BaseConfigs.GetTablePrefix+@"userfields] SET [website]=@website,[icq]=@icq,[qq]=@qq,[yahoo]=@yahoo,[msn]=@msn,[skype]=@skype,[location]=@location,[customstatus]=@customstatus,
...
WHERE [uid]=@uid";
            DbHelper.ExecuteNonQuery(CommandType.Text, updatyeuserfields, parms1);
        ...
        public void UpdateUserProfile(UserInfo userinfo)
        {
            ...
            OleDbConnection conn = new OleDbConnection(BaseConfigs.GetDBConnectString);
            conn.Open();
            using (OleDbTransaction trans = conn.BeginTransaction())
            {
                try
        ...
        public void UpdateUserForumSetting(UserInfo userinfo)
        {
            ...
            DbParameter[] prams2 ={
                ...
                DbHelper.MakeInParam("@signature", (DbType)OleDbType.VarChar, 500, userinfo.Signature),
                
                DbHelper.MakeInParam("@sightml", (DbType)OleDbType.VarChar, 1000, userinfo.Sightml),
                DbHelper.MakeInParam("@customstatus",(DbType)OleDbType.VarChar,30,userinfo.Customstatus),
                 DbHelper.MakeInParam("@uid",(DbType)OleDbType.Integer,4,userinfo.Uid)
            };
            DbHelper.ExecuteNonQuery(CommandType.Text, "UPDATE [" + BaseConfigs.GetTablePrefix + "users] SET [tpp]=@tpp, [ppp]=@ppp, [invisible]=@invisible,[sigstatus]=@sigstatus WHERE [uid]=@uid", prams1);
        ...
        public void UpdateUserPreference(int uid, string avatar, int avatarwidth, int avatarheight, int templateid)
        {
            ...
            DbHelper.ExecuteNonQuery(CommandType.Text, "UPDATE [" + BaseConfigs.GetTablePrefix + "userfields] SET [avatar]=@avatar, [avatarwidth]=@avatarwidth, [avatarheight]=@avatarheight WHERE [uid]=@uid", prams);
            ...
            DbHelper.ExecuteNonQuery(CommandType.Text, "UPDATE [" + BaseConfigs.GetTablePrefix + "users] SET [templateid]=@templateid WHERE [uid]=@uid", prams1);
        ...
        public void UpdateUserPassword(int uid, string password, bool originalpassword)
        {
            ...
            DbParameter[] prams = {
                                       DbHelper.MakeInParam("@password", (DbType)OleDbType.Char, 32, originalpassword ? Utils.MD5(password) : password),
									   DbHelper.MakeInParam("@uid", (DbType)OleDbType.Char, 4, uid)
        ...
        public void UpdateUserLastvisit(int uid, string ip)
        {
            ...
            DbHelper.ExecuteNonQuery(CommandType.Text, "UPDATE [" + BaseConfigs.GetTablePrefix + "users] SET [lastvisit]=NOW(), [lastip]=@ip WHERE [uid] =@uid", parms);
        }
        ...
        public DataTable GetUserIdByAuthStr(string authstr)
        {
            ...
            DataTable dt = DbHelper.ExecuteDataset(CommandType.Text, "SELECT [uid] FROM [" + BaseConfigs.GetTablePrefix + "userfields] WHERE DateDiff(\"d\",[authtime],date())<=3  AND [authstr]=@authstr", prams).Tables[0];
        ...
        public int AddOnlineUser(OnlineUserInfo onlineuserinfo, int timeout, int deletingfrequency)
        {
            ...
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@newpms",(DbType)OleDbType.Integer,2,onlineuserinfo.Newpms),
									   DbHelper.MakeInParam("@newnotices",(DbType)OleDbType.Integer,2,onlineuserinfo.Newnotices)
								   };
            ...
            //int olid = Utils.StrToInt(DbHelper.ExecuteScalar(CommandType.StoredProcedure, string.Format("{0}createonlineuser", BaseConfigs.GetTablePrefix), parms), 0);
            if (onlinestate == 0)
            {
                sql = "UPDATE [" + BaseConfigs.GetTablePrefix + "users] SET [onlinestate]=1 WHERE [uid]=" + onlineuserinfo.Userid;
                olid = Utils.StrToInt(DbHelper.ExecuteNonQuery(CommandType.Text, sql), 0);
            }
            //else
            //{
            int id = 0;
            sql = "INSERT INTO [" + BaseConfigs.GetTablePrefix + "online] ([userid],[ip],[username],[nickname],[password],[groupid],[olimg],[adminid],[invisible],[action],[lastactivity],[lastposttime],[lastpostpmtime],[lastsearchtime],[lastupdatetime],[forumid],[forumname],[titleid],[title],[verifycode],[newpms],[newnotices])VALUES(@userid,@ip,@username,@nickname,@password,@groupid,@olimg,@adminid,@invisible,@action,@lastactivity,@lastposttime,@lastpostpmtime,@lastsearchtime,@lastupdatetime,@forumid,@forumname,@titleid,@title,@verifycode,@newpms,@newnotices)";
            DbHelper.ExecuteNonQuery(out id, CommandType.Text, sql, parms);
            //sql = "SELECT [olid] FROM ["+ BaseConfigs.GetTablePrefix +"online] ORDER BY [olid] DESC";
            olid = id;
            //}
            ...
            if (olid > 2147483000)
            {
                ...
                sql = "INSERT INTO [" + BaseConfigs.GetTablePrefix + "online] ([userid],[ip],[username],[nickname],[password],[groupid],[olimg],[adminid],[invisible],[action],[lastactivity],[lastposttime],[lastpostpmtime],[lastsearchtime],[lastupdatetime],[forumid],[forumname],[titleid],[title],[verifycode],[newpms],[newnotices])VALUES(@userid,@ip,@username,@nickname,@password,@groupid,@olimg,@adminid,@invisible,@action,@lastactivity,@lastposttime,@lastpostpmtime,@lastsearchtime,@lastupdatetime,@forumid,@forumname,@titleid,@title,@verifycode,@newpms,@newnotices)";
                DbHelper.ExecuteNonQuery(CommandType.Text, sql, parms);
                //sql = "SELECT MAX([olid]) FROM [" + BaseConfigs.GetTablePrefix + "online]";
                //olid = Utils.StrToInt(DbHelper.ExecuteScalar(CommandType.Text, sql), 0);
                //}
                return 1;
            }
        ...
        private void DeleteExpiredOnlineUsers(int timeout)
        {
            ...
            if (memberStrBuilder.Length > 0)
            {
                ...
                strDelTimeOutSql = string.Format("UPDATE [{0}users] SET [onlinestate]=0,[lastactivity]=NOW() WHERE [uid] IN ({1});", BaseConfigs.GetTablePrefix, memberStrBuilder.ToString());
            }
        ...
        public void UpdateUserPMSetting(UserInfo user)
        {
            ...
            parms = new DbParameter[] {
                                    DbHelper.MakeInParam("@ignorepm", (DbType)OleDbType.VarWChar, 1000, user.Ignorepm),
                                    DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, user.Uid)
                                  };
        ...
        public void UpdateBanUser(int groupid,string groupexpiry,int uid)
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@groupid", (DbType)OleDbType.Integer, 4, groupid),
                                    DbHelper.MakeInParam("@groupexpiry", (DbType)OleDbType.VarWChar, 50, groupexpiry),
                                    DbHelper.MakeInParam("@uid", (DbType)OleDbType.Integer, 4, uid)
                                };
        ...
        public DataTable SearchSpecialUser(int fid)
        {
            ...
            string sql = "SELECT * FROM [" + BaseConfigs.GetTablePrefix + "forums] f1 LEFT JOIN [" + BaseConfigs.GetTablePrefix + "forumfields] f2 ON [f1].[fid]=[f2].[fid] where [f1].[fid]=@fid";
        ...
        {
            DbParameter[] parms = { 
                                     DbHelper.MakeInParam("@pluscount",(DbType)OleDbType.Integer, 2, short.Parse(pluscount.ToString())),
                                     DbHelper.MakeInParam("@olid",(DbType)OleDbType.Integer, 4, olid)
                                  };
