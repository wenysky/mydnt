...
namespace Discuz.Forum
{
    ...
    public class ForumUtils
    {
        ...
        public static bool CreateShowForumCacheFile(int fid, int pageid, string pagetext)
        {
            ...
            if (IsGuestCachePage(pageid, "showforum"))
            {
                ...
                if (!string.IsNullOrEmpty(pagetext))
                {
                    ...
                    pagetext += "\r\n<!-- Discuz!NT CachedPage (Created: " + Utils.GetDateTime() + ") -->";
                    cache.AddObject("/Forum/ShowForumGuestCachePage/Fid_" + fid + "/Page_" + pageid + "/", pagetext, MemCachedConfigs.GetConfig().CacheShowForumCacheTime * 60);
                    return true;
                }              
            }
            return false;
        ...
        {
            int cachenumber = (mcci != null && mcci.ApplyMemCached) ? mcci.CacheShowTopicPageNumber : 1;
