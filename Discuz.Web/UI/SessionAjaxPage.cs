...
namespace Discuz.Web.UI
{
    ...
    public class SessionAjaxPage : PageBase
    {
        ...
        {
            Posts.AuditPost(TypeConverter.StrToInt(Posts.GetPostTableId()), DNTRequest.GetString("pid"), "", "", "");
            StringBuilder Json = new StringBuilder("[");
            Json.Append("{pid:");
            Json.Append(DNTRequest.GetString("pid"));
            Json.Append("}]");
        ...
        {
            //Discuz.Forum.Posts.AuditPost(Convert.ToInt32(Posts.GetPostTableId(),DNTRequest.GetString("pid"),"","","");
            Posts.AuditPost(TypeConverter.StrToInt(Posts.GetPostTableId()), "", DNTRequest.GetString("pid"), "", "");
        }
        /// <summary>
        /// 忽略
        ...
        /// 审核主题
        /// </summary>
        public void PassTopic()
        {
            Topics.PassAuditNewTopic(Posts.GetPostTableId(), "", DNTRequest.GetString("tid"), "", DNTRequest.GetString("forumid"));
            StringBuilder Json = new StringBuilder("[");
            Json.Append("{tid:");
            Json.Append(DNTRequest.GetString("tid"));
            Json.Append("}]");
            ResponseJSON(Json.ToString());
        }
        /// <summary>
        ...
        public void AuditPost(string type, string reason)
        {
            ...
            if (usergroupinfo.Radminid > 0)
            {
                ...
                {
                    case "passtopic":
                        Topics.PassAuditNewTopic(Posts.GetPostTableId(), "", tid, "", DNTRequest.GetString("forumid"));
                    ...
                    case "deletetopic":
                        ...
                        break;
                    case "passpost":
                        Posts.AuditPost(TypeConverter.StrToInt(Posts.GetPostTableId()), pid, "", "", "");
