<%@ Page language="c#" Inherits="Discuz.Web.Admin.addfirstforum" Codebehind="forum_addfirstforum.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		...
		<td class="vtop">设置版块URL重写,以字母开头,其后可以是字母或数字,但不可包含<br>"install,upgrade,admin,aspx,tools,archive,space"中任意一个字符串</td>
	</tr>
