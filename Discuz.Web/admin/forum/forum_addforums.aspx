<%@ Page language="c#" Inherits="Discuz.Web.Admin.addforums" Codebehind="forum_addforums.aspx.cs"%>
...
<table width="100%">
	...
	<tr>
		...
		<td class="vtop">设置版块URL重写,会以"http://nt.discuz.net/rewritename/"的形式显示,以字母开头,其后可以是字母或数字,但不可包含"install,upgrade,admin,aspx,tools,archive,space"中任意一个字符串</td>
	</tr>
