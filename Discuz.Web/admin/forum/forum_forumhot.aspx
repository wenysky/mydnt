 ...
 htmlcount="";
  if(value=="topics")
  {
	 ...
	 html+=' <h3 class="item_title">版块列表</h3><select name="forumid" id="topics_select_forumid" size="5" multiple="multiple">'
	  ...
	  html+='<option value="<%=drforum["fid"]%>"><%=drforum["name"]%></option>'
			<%}%>
	  <%}%>
	 html+='</select>'
	 
	htmlcount+='<select name="topiccount" id="topiccount">';
	htmlcount+='<option value="8">8</option>';
	htmlcount+='<option value="15">15</option>';				
	htmlcount+='</select>';
  ...
  if(value=="forums")
  {
  	...
  	html+='<h3 class="item_title">排序方式</h3><select name="sorttype" id="forums_list_sorttype">'
		...
		html+='<option value="todayposts">今日发帖数</option>'
	html+='</select>'	
  ...
  if(value=="users")
  {
  	html+='<h3 class="item_title">排序方式</h3><select name="sorttype" id="users_list_sorttype">'
...
<div class="ManagerForm ntcplist">
...
<tbody>
  ...
  <%if(id!=6){%>
	<tr><td colspan="2" class="item_title">是否开启</td></tr>
	<tr>
		<td class="vtop rowform">
  ...
  <%if(id!=6){%>
	<tr><td colspan="2" class="item_title">版块名称长度</td></tr>
	<tr>
		<td class="vtop rowform">
  ...
  <%}%>
	<tr><td colspan="2" class="item_title">标题长度</td></tr>
	<tr>
		<td class="vtop rowform">
...
//selectedoption('topics_select_forumid','<%=dr["forumid"].ToString()%>')
}
...
if(value=="users")
{
selectedoption('users_list_sorttype','<%=dr["sorttype"].ToString()%>');
}
