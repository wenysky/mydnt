...
<fieldset>
	...
	<tr>
		...
		<td class="vtop">帖子作者发帖后超过此时间限制将不能再编辑帖, 版主和管理员不受此限制, 0 为不限制</td>
	</tr>
	...
	<tr><td class="item_title" colspan="2">是否允许使用HTML标题</td></tr>
	<tr>
		<td class="vtop rowform">
			<cc1:RadioButtonList id="allowhtmltitle" runat="server" RepeatLayout="flow">
				<asp:ListItem Value="1">是</asp:ListItem>
				<asp:ListItem Value="0">否</asp:ListItem>
			</cc1:RadioButtonList>
		</td>
		<td class="vtop">如果允许使用HTML标题,还需在"用户权限"中设置哪些组可以使用.</td>
	</tr>
	</tbody>
