...
namespace Discuz.Web.Admin
{
    public partial class option : AdminPage
    {
        ...
        private void SaveInfo_Click(object sender, EventArgs e)
        {
            ...
            inputrule[1] = new string[] { "删帖不减积分时间", "编辑帖子时间", "每页主题数", "每页主题数", "星星升级阀值", "热门话题最低帖数",
            ...
            if (TypeConverter.StrToInt(edittimelimit.Text) > 9999999 || TypeConverter.StrToInt(edittimelimit.Text) < 0)
            {
                base.RegisterStartupScript("", "<script>alert('编辑帖子时间限制只能在0-9999999之间');window.location.href='forum_option.aspx';</script>");
                return;
            }
