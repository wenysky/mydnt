<%@ Page Language="c#" Inherits="Discuz.Web.Admin.edituser" Codebehind="global_edituser.aspx.cs" %>
...
<table width="100%">
	<tr><td class="item_title" colspan="2">用户名(UID:<%=Discuz.Common.DNTRequest.GetString("uid")%>)</td></tr>
	<tr>
