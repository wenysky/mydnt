...
<table width="100%">
	...
	<tr><td class="item_title" colspan="2"> 显示最近访问论坛数量</td></tr>
	<tr>
		<td class="vtop rowform">
			 <cc1:TextBox id="visitedforums" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Size="6" MaxLength="4"></cc1:TextBox>		</td>
		<td class="vtop">设置在论坛列表和帖子浏览中, 显示的最近访问过的论坛下拉列表数量, 建议设置为 30 以内, 0 为关闭此功能</td>
	</tr>
	...
	<tr>
		...
		<td class="vtop">设置帖子中允许显示签名的最大高度, 0 为不限制. 注意: 本限制只对 IE 浏览器有效</td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			<uc1:TextareaResize id="postnocustom" runat="server" cols="45" controlname="Linktext" HintPosOffSet="160"></uc1:TextareaResize>		</td>
	...
	<tr><td class="item_title" colspan="2">是否开启论坛热点功能</td></tr>
	<tr>
		<td class="vtop rowform">
			<cc1:RadioButtonList id="forumhot" runat="server" RepeatLayout="flow" HintPosOffSet="80">
				<asp:ListItem Value="1">是</asp:ListItem>
				<asp:ListItem Value="0">否</asp:ListItem>
			</cc1:RadioButtonList>		</td>
		<td class="vtop"><div id="forumhotlayer">[<a href="../forum/forum_forumhot.aspx">编辑热点信息</a>]</div></td>
	</tr>
