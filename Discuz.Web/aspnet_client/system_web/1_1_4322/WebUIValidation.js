...
function ValidatorUpdateDisplay(val) {
    ...
    if(!val.isvalid)
    {
        document.getElementById(val.controltovalidate).style.borderColor='red';
    }
    else
    {
		document.getElementById(val.controltovalidate).style.borderColor='#C0C0C0';
    }
...
function ValidatorCommonOnSubmit1() {
