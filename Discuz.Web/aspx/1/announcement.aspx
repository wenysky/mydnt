...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("	<dl class=\"announce s_clear\">\r\n");
	templateBuilder.Append("		<dt class=\"f_bold\"><a name=\"" + announcement["id"].ToString().Trim() + "\"></a>" + announcement["title"].ToString().Trim() + "</dt>\r\n");
	templateBuilder.Append("		<dd>\r\n");
	 aspxrewriteurl = this.UserInfoAspxRewrite(announcement["posterid"].ToString().Trim());
	
	templateBuilder.Append("			<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" class=\"lightlink\">" + announcement["poster"].ToString().Trim() + "</a>  发表于: <span class=\"time\">\r\n");
	templateBuilder.Append(Convert.ToDateTime(announcement["starttime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
	templateBuilder.Append("</span>\r\n");
	templateBuilder.Append("			结束于:<span class=\"time\">\r\n");
	templateBuilder.Append(Convert.ToDateTime(announcement["endtime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
	templateBuilder.Append("</span>\r\n");
	templateBuilder.Append("		</dd>\r\n");
	templateBuilder.Append("		<dd>\r\n");
