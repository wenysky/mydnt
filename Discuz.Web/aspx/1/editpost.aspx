...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:13:15.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:13:15. 
	*/
	...
	templateBuilder.Append("<strong>编辑帖子</strong>\r\n");
	templateBuilder.Append("    </div>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<script type=\"text/javascript\">\r\n");
	...
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("\";\r\n");
	templateBuilder.Append("var posturl=forumpath+'editpost.aspx?topicid=");
	...
	templateBuilder.Append("	<div style=\"display: none;\" id=\"specialposttable\">\r\n");

	if (topic.Special==1)
	{

	templateBuilder.Append("	<div class=\"exfm cl\">\r\n");
	templateBuilder.Append("		<div class=\"sinf z\">\r\n");
	templateBuilder.Append("			<div class=\"cl\">\r\n");
	templateBuilder.Append("				<h4><em>选项:</em>每行填写 1 个选项</h4>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div id=\"polloptions\" class=\"mbm\">\r\n");
	...
	templateBuilder.Append("					<input type=\"text\" class=\"txt\" style=\"margin-right:2px\" size=\"2\" name=\"displayorder\" maxlength=\"4\" value=\"" + poll["displayorder"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("					<input type=\"text\" name=\"pollitemid\" value=\"" + poll["name"].ToString().Trim() + "\" class=\"optioninfo txt\" />\r\n");
	templateBuilder.Append("					<a href=\"javascript:;\" class=\"del y\" title=\"删除投票项\" onclick=\"if(!delObj(document.getElementById('polloptions'),2)){alert('投票项不能少于2个');}\">del</a>\r\n");
	templateBuilder.Append("				</p>\r\n");
	...
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"sadd z\">\r\n");
	templateBuilder.Append("			<p class=\"mbn\"><label for=\"polldatas\">投票结束日期</label>\r\n");
	templateBuilder.Append("				<input name=\"enddatetime\" type=\"text\" id=\"enddatetime\" class=\"txt\" size=\"10\" value=\"");
	...
	templateBuilder.Append("			</p>\r\n");
	templateBuilder.Append("			<p class=\"mbn\"><label for=\"pollnum\">\r\n");
	...
	templateBuilder.Append("				onclick=\"this.checked?$('maxchoicescontrol').style.display='':$('maxchoicescontrol').style.display='none';\" />多选投票\r\n");
	...
	templateBuilder.Append("			</p>\r\n");
	templateBuilder.Append("			<p class=\"mbn\"><input type=\"checkbox\" tabindex=\"1\" name=\"allowview\" \r\n");
	...
	templateBuilder.Append("	<div class=\"exfm cl\">\r\n");
	templateBuilder.Append("		<label for=\"rewardprice\">悬赏价格:</label>\r\n");
	...
	templateBuilder.Append("	<div class=\"exfm cl\">\r\n");
	templateBuilder.Append("		<label for=\"rewardprice\">悬赏价格:</label>\r\n");
	templateBuilder.Append("		<input name=\"topicprice\" type=\"hidden\" id=\"topicprice\" value=\"");
	templateBuilder.Append(usergroupinfo.Minbonusprice.ToString().Trim());
	templateBuilder.Append("\" />\r\n");
	templateBuilder.Append("		");
	templateBuilder.Append(topic.Price.ToString().Trim());
	...
	templateBuilder.Append("					<dt><strong class=\"rq\">*</strong><label for=\"affirmpoint\">正方:</label></dt>\r\n");
	templateBuilder.Append("					<dd><textarea tabindex=\"1\" class=\"txtarea\" id=\"positiveopinion\" name=\"positiveopinion\" style=\"width: 210px;\" >");
	templateBuilder.Append(debateinfo.Positiveopinion.ToString().Trim());
	templateBuilder.Append("</textarea></dd>\r\n");
	templateBuilder.Append("					<dt><strong class=\"rq\">*</strong><label for=\"negapoint\">反方:</label></dt>				\r\n");
	templateBuilder.Append("					<dd><textarea tabindex=\"1\" class=\"txtarea\" id=\"negativeopinion\" name=\"negativeopinion\" style=\"width: 210px;\" >");
	templateBuilder.Append(debateinfo.Negativeopinion.ToString().Trim());
	templateBuilder.Append("</textarea></dd>\r\n");
	templateBuilder.Append("				</dl>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div class=\"sadd\">\r\n");
	...
	templateBuilder.Append("					<input type=\"hidden\" name=\"updatedebate\" id=\"updatedebate\" value=\"1\" />\r\n");
	templateBuilder.Append("				</p>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<script type=\"text/javascript\">\r\n");
	...
	templateBuilder.Append("	<script type=\"text/javascript\">\r\n");
	templateBuilder.Append("		isfirstpost  = ");
