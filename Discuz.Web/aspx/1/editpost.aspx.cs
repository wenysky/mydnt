...
namespace Discuz.Web
{
    ...
    public class editpost : PageBase
    {
        ...
        private StringBuilder SetAttachmentInfo()
        {
            ...
            AttachmentInfo[] editPostAttachArray = Attachments.GetEditPostAttachArray(postinfo.Posterid, attachId);
        ...
        protected string AttachmentList()
        {
            ...
            foreach (DataRow dr in attachmentlist.Rows)
            {
                ...
                html.AppendFormat("<a href=\"javascript:;\" onclick=\"delImgAttach({0},1)\" class=\"del y\">删除</a>", dr["aid"].ToString().Trim());
