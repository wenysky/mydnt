...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("		<p class=\"channelinfo f_clear right\">共搜索到<span id=\"resultcount\"></span>个符合条件的版块</p>\r\n");
	templateBuilder.Append("		<h1>版块搜索结果</h1>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("	<div class=\"mainbox\" style=\"border-top:1px solid #D3E0EC;\">\r\n");
	templateBuilder.Append("	<table summary=\"版块搜索\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
	templateBuilder.Append("		<thead class=\"category\">\r\n");
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				<td style=\"background:#EEF4F9;border-bottom:1px solid #D3E0EC;padding:4px 0;text-align:left;padding-left:55px;\">版块</td>\r\n");
	templateBuilder.Append("				<td class=\"nums\" style=\"background:#EEF4F9;border-bottom:1px solid #D3E0EC;padding:4px 0;text-align:center;\">主题</td>\r\n");
	templateBuilder.Append("				<td class=\"nums\" style=\"background:#EEF4F9;border-bottom:1px solid #D3E0EC;padding:4px 0;text-align:center;\">帖子</td>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("		</thead>\r\n");
	templateBuilder.Append("		<tbody class=\"list\">\r\n");
	...
	templateBuilder.Append("	<script type=\"text/javascript\">\r\n");
	templateBuilder.Append("	$('resultcount').innerHTML = ");
	...
	templateBuilder.Append("	<div class=\"zerothreads\">没有搜索到你要查找的版块</div>\r\n");

	}	//end if

	templateBuilder.Append("	<div style=\"border-top:1px solid #D3E0EC;padding-top:20px;\"><input type=\"text\" size=\"40\" value=\"");
