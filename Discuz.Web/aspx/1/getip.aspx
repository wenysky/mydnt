...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<form id=\"form2\" name=\"form2\" action=\"getip.aspx?topicid=");
	...
	templateBuilder.Append("&infloat=1&\" method=\"post\" onsubmit=\"javascript:$('form2').action='");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("		<span class=\"y\"><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('getip')\" title=\"关闭\">关闭</a></span>\r\n");
	templateBuilder.Append("	    <em id=\"return_mods\">查看 IP</em>\r\n");
	...
	templateBuilder.Append("				    <th width=\"60\">IP地址:</th>\r\n");
	...
	templateBuilder.Append("				    <td><button type=\"submit\" onClick=\"return confirm('你确实要禁止此IP吗?');\"/>禁止此 IP</button> </td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("		    </tbody>\r\n");
	...
	templateBuilder.Append("				<th> </th>\r\n");
	templateBuilder.Append("				<td>\r\n");
	templateBuilder.Append("				<a href=\"###\" onClick=\"if(confirm('你确实要禁止此IP吗?')){window.location.replace('getip.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&pid=");
	templateBuilder.Append(postid.ToString());
	templateBuilder.Append("&action=ipban&ip=");
