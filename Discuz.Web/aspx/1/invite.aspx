...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:13:05.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:13:05. 
	*/
	...
	templateBuilder.Append("	<!--弹窗start-->\r\n");
	...
	templateBuilder.Append("	        setTimeout('location.reload()', 2000);\r\n");
	templateBuilder.Append("		</");
	templateBuilder.Append("script>		\r\n");
	...
	templateBuilder.Append("		<em id=\"returnmessage\">发送邀请码</em>\r\n");
	templateBuilder.Append("		<span class=\"y\"><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('emailtoinvite')\" title=\"关闭\">关闭</a></span>\r\n");
	templateBuilder.Append("	</h3>\r\n");
	templateBuilder.Append("	<div id=\"floatwinemailbox\" style=\" text-align:left; margin:20px\">\r\n");
	templateBuilder.Append("	<form id=\"sendcodeonfloat\" method=\"post\" onsubmit=\"javascript:$('sendcodeonfloat').action='invite.aspx?action=floatwinemailsend&invitecode=");
	...
	templateBuilder.Append("           <li style=\"padding-bottom:8px\">邀请码:<a href=\"javascript:;\" onclick=\"copycodeinfloat('");
	templateBuilder.Append(invitecode.ToString());
	templateBuilder.Append("');\">");
	templateBuilder.Append(invitecode.ToString());
	...
	templateBuilder.Append("           <li style=\"padding-bottom:8px\">Email: <input id=\"floatwinemail\" name=\"email\" type=\"text\" style=\"width:300px;margin-right:10px;\" class=\"txt\"/><br/>(多个地址用\",\"分割)</li>\r\n");
	templateBuilder.Append("           <li><button name=\"emailtoinvite\" title=\"通过Email将邀请链接发送给好友\" type=\"submit\" id=\"floatwinemailtoinvite\" onclick=\"return checkStrNullOrEmptyInFloat('floatwinemail','Email地址不能为空')\">发送给好友</button></li>\r\n");
	templateBuilder.Append("        </ul>\r\n");
	templateBuilder.Append("	</form>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("	<script type=\"text/javascript\" reload=\"1\">\r\n");
	templateBuilder.Append("	    function checkStrNullOrEmptyInFloat(str, message) {\r\n");
	templateBuilder.Append("	        var s = $(str).value;\r\n");
	templateBuilder.Append("	        if (s == '') {\r\n");
	templateBuilder.Append("	            $('returnmessage').innerHTML = '<p>' + message + '</p>';\r\n");
	templateBuilder.Append("	            return false;\r\n");
	templateBuilder.Append("	        }\r\n");
	templateBuilder.Append("	        return true;\r\n");
	templateBuilder.Append("	    }\r\n");
	templateBuilder.Append("        function copycodeinfloat(obj) {\r\n");
	templateBuilder.Append("            obj = '");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("invite.aspx?invitecode=' + obj;\r\n");
	templateBuilder.Append("//            if(is_moz)\r\n");
	templateBuilder.Append("//               floatwin('close_emailtoinvite');\r\n");
	templateBuilder.Append("            setcopy(is_ie ? obj.replace(/\\r\\n\\r\\n/g, '\\r\\n') : obj, '复制完成');\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("    </");
	templateBuilder.Append("script>\r\n");
	...
	templateBuilder.Append("	<!--弹窗over-->\r\n");

	}
	else
	{

	templateBuilder.Append("	<!--非弹窗start-->\r\n");
	templateBuilder.Append("<script type=\"text/javascript\">\r\n");
	templateBuilder.Append("    function copycode(obj) {\r\n");
	templateBuilder.Append("        setcopy(is_ie ? obj.value.replace(/\\r\\n\\r\\n/g, '\\r\\n') : obj.value, '复制完成');\r\n");
	templateBuilder.Append("    }\r\n");
	templateBuilder.Append("    function checkStrNullOrEmpty(str, message) {\r\n");
	templateBuilder.Append("        var s = $(str).value;\r\n");
	templateBuilder.Append("        if (s == '') {\r\n");
	templateBuilder.Append("            alert(message);\r\n");
	templateBuilder.Append("            return false;\r\n");
	templateBuilder.Append("        }\r\n");
	templateBuilder.Append("        return true;\r\n");
	templateBuilder.Append("    }\r\n");
	templateBuilder.Append("    function usersaidPriview() {\r\n");
	templateBuilder.Append("        $('usersaidinemail').innerHTML = $('usersaid').value;\r\n");
	templateBuilder.Append("    }\r\n");
	templateBuilder.Append("</");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("<div class=\"wrap s_clear pageinfo\">\r\n");
	templateBuilder.Append("	<div id=\"nav\"><a href=\"");
	...
	templateBuilder.Append("	<div class=\"wrap s_clear\" id=\"wrap\">\r\n");
	templateBuilder.Append("	<div class=\"main\" style=\"padding:18px 28px\">\r\n");
	templateBuilder.Append("	<h1>邀请注册</h1>\r\n");
	...
	templateBuilder.Append("				<form id=\"createinvitecode\" method=\"post\" action=\"invite.aspx?action=createcode\">\r\n");
	templateBuilder.Append("					<table summary=\"邀请注册\" cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\"  id=\"invitecodemsg\">\r\n");
	templateBuilder.Append("					<tr id=\"promotiondescription\">\r\n");
	templateBuilder.Append("						<td>");
	templateBuilder.Append(invitationconfiginfo.InvitationLoginUserDescription.ToString().Trim());
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("					</tr>\r\n");
	templateBuilder.Append("					<tr>\r\n");
	templateBuilder.Append("						<td><button name=\"createcode\" type=\"submit\" id=\"createcode\">我要加入</button></td></td>\r\n");
	templateBuilder.Append("					</tr>\r\n");
	...
	templateBuilder.Append("				<div style=\"margin-top:20px\">\r\n");
	templateBuilder.Append("				 您可以通过QQ、MSN等IM工具，或者发送邮件，把下面的链接告诉你的好友，邀请他们加入进来。<br />\r\n");
	...
	templateBuilder.Append("				</div>\r\n");
	templateBuilder.Append("				<hr class=\"solidline\"/>\r\n");
	templateBuilder.Append("				<form id=\"convertinvitecode\" method=\"post\" action=\"invite.aspx?action=convertcode\">\r\n");
	templateBuilder.Append("				<table summary=\"邀请注册\" cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\"  id=\"invitecodemsg\">\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th><label for=\"invitecode\">推广链接:</label></th>\r\n");
	templateBuilder.Append("					<td><input id=\"invitecode\" title=\"双击文本框复制推广链接\" type=\"text\" value=\"");
	...
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th><label for=\"successcount\">成功邀请用户:</label></th>\r\n");
	templateBuilder.Append("					<td>");
	templateBuilder.Append(invitecodeinfo.SuccessCount.ToString().Trim());
	templateBuilder.Append("人 </td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th><label for=\"userscore\">可兑换到的积分:</label></th>\r\n");
	templateBuilder.Append("					<td>");
	...
	templateBuilder.Append("				</form>\r\n");
	templateBuilder.Append("				<hr class=\"solidline\"/>\r\n");
	templateBuilder.Append("				<h1>邮件邀请朋友</h1>\r\n");
	templateBuilder.Append("				<div style=\"padding-top:20px\">\r\n");
	templateBuilder.Append("				<table summary=\"用户自定义邮件内容\" cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\"  id=\"userscript\">\r\n");

	if (isuseusersaid)
	{

	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("				   <th><label for=\"usersaid\">想对好友说的话:</label></th>\r\n");
	templateBuilder.Append("				   <td><input id=\"usersaid\" name=\"usersaid\" type=\"text\" style=\"width:350px;margin-right:10px;\" onkeyup=\"usersaidPriview();\" /></td>\r\n");
	templateBuilder.Append("				</tr>\r\n");

	}	//end if

	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("				   <th colspan=\"2\"><label for=\"emailpreview\">邮件内容预览:</label></th>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("				   <td colspan=\"2\">\r\n");
	templateBuilder.Append("				     <div style=\"overflow:hidden;zoom:1;border:1px dashed #CCC;margin-top:10px;background:#FBFBFB; padding:20px\">");
	templateBuilder.Append(emailpreview.ToString());
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("				   </td>				   \r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("				   <td colspan=\"2\"><button onclick=\"showWindow('emailtoinvite', '");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("		   <div id=\"userinvitecodelist\" class=\"datalist\" style=\" margin-top:20px\">\r\n");
	templateBuilder.Append("		   <div class=\"hintinfo\" style=\"margin-top:0\">您拥有的扩展积分:");
	templateBuilder.Append(CreateUserExtCreditsStr().ToString());
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("		   <div class=\"hintinfo\" style=\"margin-top:0\">您购买的邀请码会在失效之后由系统定时清理，不会长期驻留在列表中</div>\r\n");

	if (invitecodecount>0)
	{

	templateBuilder.Append("				<table summary=\"邀请码\" cellspacing=\"0\" cellpadding=\"0\" class=\"datatable\" id=\"invitecodelist\">\r\n");
	templateBuilder.Append("				<thead class=\"colplural\">\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th>邀请码</th>\r\n");
	templateBuilder.Append("					<th>购买时间</th>\r\n");
	templateBuilder.Append("					<th>过期时间</th>\r\n");
	templateBuilder.Append("					<th>可使用次数</th>\r\n");
	templateBuilder.Append("					<th>已使用次数</th>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	...
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<td><a href=\"javascript:;\" onclick=\"showWindow('emailtoinvite', '");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("invite.aspx?action=floatwinemail&invitecode=");
	...
	templateBuilder.Append("				<div class=\"zerothreads\">您还没有购买邀请码</div>\r\n");
	...
	templateBuilder.Append("					</div>\r\n");
	templateBuilder.Append("				   <div style=\"overflow:hidden; zoom:1; margin-bottom:10px;float:left;\">\r\n");
	templateBuilder.Append("					   <form id=\"buyinvitecode\" method=\"post\" action=\"invite.aspx?action=buycode\" style=\"float:left; margin-right:10px\">\r\n");
	templateBuilder.Append("						  <div id=\"buycode\">\r\n");
	templateBuilder.Append("							  邀请码售价: ");
	...
	templateBuilder.Append("		<table summary=\"邀请注册\" cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\"  id=\"invitecodemsg\">\r\n");
	templateBuilder.Append("		<tr id=\"visitordescription\">\r\n");
	templateBuilder.Append("			<td>");
	...
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("		    <td>\r\n");
	templateBuilder.Append("		    <div style=\"overflow:hidden;zoom:1;border:1px dashed #CCC;margin-top:20px;background:#FBFBFB; padding:20px\">\r\n");
	...
	templateBuilder.Append("			    <div id=\"creatormessage\" style=\"vertical-align:top\">您好:<br/>您的朋友 ");
	...
	templateBuilder.Append("		<!--非弹窗over-->\r\n");
	templateBuilder.Append("	</div>\r\n");
