...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:13:02.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:13:02. 
	*/
	...
	templateBuilder.Append("			$('returnmessage').innerHTML='用户登录';\r\n");
	templateBuilder.Append("			</");
	templateBuilder.Append("script>	\r\n");
	...
	templateBuilder.Append("	<div class=\"wrap cl\">\r\n");
	templateBuilder.Append("		<div class=\"blr\" id=\"floatlayout_login\">\r\n");
	...
	templateBuilder.Append("		<h3 class=\"flb\"><em id=\"returnmessage\">用户登录</em><span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('login')\" title=\"关闭\">关闭</a></span></h3>\r\n");
	...
	templateBuilder.Append("			<div style=\"overflow:hidden;overflow-y:auto\" class=\"lgfm\">\r\n");

	if (config.Emaillogin==1)
	{

	templateBuilder.Append("				<p>您可以使用Email或用户名登录</p>\r\n");

	}	//end if

	templateBuilder.Append("				<div class=\"sipt lpsw\">\r\n");
	templateBuilder.Append("					<label for=\"username\" onclick=\"document.form1.username.focus();\">用户名　：</label>\r\n");
	templateBuilder.Append("					<input type=\"text\" class=\"txt\" tabindex=\"1000\" value=\"");
	...
	templateBuilder.Append("					<input type=\"password\" tabindex=\"1001\" class=\"txt\" size=\"36\" name=\"password\" id=\"password3\"/>\r\n");
	templateBuilder.Append("				</div>\r\n");
	...
	templateBuilder.Append("				<div class=\"lpsw\" style=\"position: relative;margin-bottom:10px;\">\r\n");
	...
	templateBuilder.Append("				<div class=\"ftid sltp\" style=\"margin-bottom:10px\">\r\n");
	templateBuilder.Append("					<select name=\"question\" id=\"question\" change=\"changequestion();\" tabindex=\"1003\">\r\n");
	templateBuilder.Append("						<option value=\"0\">安全提问</option>\r\n");
	templateBuilder.Append("						<option onclick=\"loadselect_liset('question', 0, 'question','1',this.innerHTML, 1)\" value=\"1\" k_id=\"question\">母亲的名字</option>\r\n");
	templateBuilder.Append("						<option onclick=\"loadselect_liset('question', 0, 'question','2',this.innerHTML, 2)\" value=\"2\" k_id=\"question\">爷爷的名字</option>\r\n");
	templateBuilder.Append("						<option onclick=\"loadselect_liset('question', 0, 'question','3',this.innerHTML, 3)\" value=\"3\" k_id=\"question\">父亲出生的城市</option>\r\n");
	templateBuilder.Append("						<option onclick=\"loadselect_liset('question', 0, 'question','4',this.innerHTML, 4)\" value=\"4\" k_id=\"question\">您其中一位老师的名字</option>\r\n");
	templateBuilder.Append("						<option onclick=\"loadselect_liset('question', 0, 'question','5',this.innerHTML, 5)\" value=\"5\" k_id=\"question\">您个人计算机的型号</option>\r\n");
	templateBuilder.Append("						<option onclick=\"loadselect_liset('question', 0, 'question','6',this.innerHTML, 6)\" value=\"6\" k_id=\"question\">您最喜欢的餐馆名称</option>\r\n");
	templateBuilder.Append("						<option onclick=\"loadselect_liset('question', 0, 'question','7',this.innerHTML, 7)\" value=\"7\" k_id=\"question\">驾驶执照的最后四位数字</option>\r\n");
	templateBuilder.Append("					</select>\r\n");
	templateBuilder.Append("					<script type=\"text/javascript\">simulateSelect('question','214');</");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("					<script type=\"text/javascript\">\r\n");
	templateBuilder.Append("					    window.onload = function(){setselect(");
	templateBuilder.Append(question.ToString());
	templateBuilder.Append(");}\r\n");
	templateBuilder.Append("				        function changequestion() {\r\n");
	templateBuilder.Append("				            if ($('question').getAttribute(\"selecti\") != \"0\") {\r\n");
	templateBuilder.Append("				                $('answer').style.display = '';\r\n");
	templateBuilder.Append("						        $('answer').focus();\r\n");
	templateBuilder.Append("				            }\r\n");
	templateBuilder.Append("				            else {\r\n");
	...
	templateBuilder.Append("				            }\r\n");
	templateBuilder.Append("				        }\r\n");
	templateBuilder.Append("				        function setselect(value) {\r\n");
	templateBuilder.Append("				            try {\r\n");
	templateBuilder.Append("                                var questionarray = new Array('安全提问','母亲的名字','爷爷的名字','父亲出生的城市','您其中一位老师的名字','您个人计算机的型号','您最喜欢的餐馆名称','驾驶执照的最后四位数字');\r\n");
	templateBuilder.Append("                                $('question').setAttribute(\"selecti\",value);\r\n");
	templateBuilder.Append("                                $('question').options[0].value = value;\r\n");
	templateBuilder.Append("                                $('question_ctrl').innerHTML = questionarray[value];\r\n");
	templateBuilder.Append("                                changequestion();\r\n");
	templateBuilder.Append("				            }\r\n");
	...
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("				</div>\r\n");
	templateBuilder.Append("				<div class=\"sltp\" style=\"clear:both;\"><input type=\"text\" tabindex=\"1004\" class=\"txt\" size=\"36\" autocomplete=\"off\" style=\"display: none;\" id=\"answer\" name=\"answer\"/></div>\r\n");

	}	//end if

	templateBuilder.Append("				<div class=\"sltp\"  style=\"display:none\">\r\n");
	...
	templateBuilder.Append("			<button name=\"login\" type=\"submit\" id=\"login\" tabindex=\"1005\" \r\n");
	...
	templateBuilder.Append("			<input type=\"checkbox\" value=\"43200\" tabindex=\"1\" id=\"expires\" name=\"expires\" checked/>\r\n");
	templateBuilder.Append("			<label for=\"expires\">记住我的登录状态</label>\r\n");
	templateBuilder.Append("		</p>\r\n");
	templateBuilder.Append("		<script type=\"text/javascript\">\r\n");
