...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:12:53.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:12:53. 
	*/
	...
	templateBuilder.Append("	    <div id=\"floatlayout_topicadmin\">\r\n");
	templateBuilder.Append("			<h3 class=\"flb\">\r\n");
	templateBuilder.Append("				<em id=\"return_emailfriend\">");
	...
	templateBuilder.Append("				<!--分享开始-->\r\n");

	if (action=="emailfriend")
	{

	templateBuilder.Append("				<table cellspacing=\"0\" cellpadding=\"2\">\r\n");
	templateBuilder.Append("					<tr>\r\n");
	templateBuilder.Append("						<td class=\"f_bold\" style=\"padding-bottom:10px;\">通过 QQ、MSN 分享给朋友</td>\r\n");
	templateBuilder.Append("					</tr>\r\n");
	templateBuilder.Append("					<tr>\r\n");
	templateBuilder.Append("						<td>\r\n");
	templateBuilder.Append("							<input onclick=\"hideWindow('mods');setcopy('");
	...
	templateBuilder.Append("				<form id=\"emailfriendform\" name=\"emailfriendform\" method=\"post\" action=\"misc.aspx?action=emailfriend&sendsubmit=yes&infloat=1\" onsubmit=\"ajaxpost('emailfriendform', 'return_emailfriend', 'return_emailfriend', 'onerror');return false;\">\r\n");
	templateBuilder.Append("					<input type=\"hidden\" name=\"tid\" value=\"");
	templateBuilder.Append(tid.ToString());
	templateBuilder.Append("\" />\r\n");
	templateBuilder.Append("					<table cellspacing=\"0\" cellpadding=\"2\">\r\n");
	templateBuilder.Append("						<tr>\r\n");
	templateBuilder.Append("							<td class=\"f_bold\">通过 Email 分享给朋友</td>\r\n");
	templateBuilder.Append("						</tr>\r\n");
	templateBuilder.Append("						<tr>\r\n");
	templateBuilder.Append("							<td>\r\n");
	templateBuilder.Append("								接收者 Email<br />\r\n");
	templateBuilder.Append("								<input type=\"text\" name=\"sendtoemail\" size=\"25\" class=\"txt\" /><br />\r\n");
	templateBuilder.Append("								内容<br />\r\n");
	templateBuilder.Append("								<textarea class=\"txtarea\" name=\"message\" style=\"margin-bottom: 5px; width: 202px; height: 70px;\">");
	templateBuilder.Append(emailcontent.ToString());
	templateBuilder.Append("</textarea>\r\n");
	templateBuilder.Append("								<br />\r\n");
	templateBuilder.Append("								<input name=\"sendsubmit\" type=\"submit\" value=\"发送\" class=\"pn\" style=\"font-size:12px;font-weight:400;\" />\r\n");
	templateBuilder.Append("							</td>\r\n");
	templateBuilder.Append("						</tr>\r\n");
	templateBuilder.Append("					</table>\r\n");
	templateBuilder.Append("				</form>\r\n");
	templateBuilder.Append("				<hr class=\"solidline\" />\r\n");
	templateBuilder.Append("				<div class=\"f_bold\"><a href=\"javascript:;\" onclick=\"hideWindow('mods');showWindow('postpm', 'usercppostpm.aspx?tid=");
	templateBuilder.Append(tid.ToString());
	templateBuilder.Append("&operation=pmfriend');\">通过站内短消息分享给朋友</a></div>\r\n");

	}	//end if

	templateBuilder.Append("				<!--分享结束-->\r\n");
	templateBuilder.Append("				<!--投票用户名单开始-->\r\n");

	if (action=="viewvote")
	{

	templateBuilder.Append("				<div style=\"width: 450px; height: 200px; overflow: auto;\">\r\n");
	templateBuilder.Append("					<p>查看\r\n");
	templateBuilder.Append("					<select onchange=\"hideWindow('mods');showWindow('mods', 'misc.aspx?action=viewvote&tid=");
	templateBuilder.Append(tid.ToString());
	...
	templateBuilder.Append("					<option value=\"" + polloption["polloptionid"].ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("					</select>项的投票人\r\n");
	templateBuilder.Append("					</p>\r\n");
	templateBuilder.Append("					<ul class=\"voters cl\">\r\n");
	templateBuilder.Append("					");
	...
	templateBuilder.Append("				<!--投票用户名单结束-->\r\n");
	...
	templateBuilder.Append("            <div class=\"float\" id=\"floatboxnarrow\" style=\"width: 500px; height: 350px;\">\r\n");
	templateBuilder.Append("	        <h3 class=\"flb\">\r\n");
	templateBuilder.Append("	            <em id=\"return_emailfriend\">");
	templateBuilder.Append(title.ToString());
	templateBuilder.Append("</em>\r\n");
	templateBuilder.Append("		        <span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('mods')\" title=\"关闭\">关闭</a></span>\r\n");
	templateBuilder.Append("	        </h3>\r\n");
	templateBuilder.Append("	        <div class=\"gateform\" style=\"margin:0 auto;\">\r\n");
	templateBuilder.Append("		    <p>");
	...
	templateBuilder.Append("        <script type=\"text/javascript\"  reload=\"1\">\r\n");
	templateBuilder.Append("            floatwin('close_emailfriend');	\r\n");
	templateBuilder.Append("        </");
	templateBuilder.Append("script>\r\n");
