    ...
    public class modcp : PageBase
    {
        ...
        public void AuditPost()
        {
            if (!Utils.StrIsNullOrEmpty(DNTRequest.GetString("pidlist")) && ismoder)
            {
                ...
                //    switch (DNTRequest.GetString("mod_" + pid).ToLower())
                //    {
                //        case "validate":
                //            logs.Add("帖子ID为<A href=\"" + config.Forumurl + "showtopic.aspx?pid=" + pid + "\">" + pid + "</a>  " + DNTRequest.GetString("pm_" + pid) + "", "审核通过帖子");
                //            validate = string.Concat(validate, ",", pid.ToString());
                //            break;

                //        case "delete":
                //            logs.Add("帖子ID为" + pid + "  " + DNTRequest.GetString("pm_" + pid), "删除未审核帖子");
                //            delete = string.Concat(delete, ",", pid.ToString());
                //            break;

                //        case "ignore":
                //            logs.Add("帖子ID为" + pid + "  " + DNTRequest.GetString("pm_" + pid), "忽略未审核帖子");
                //            ignore = string.Concat(ignore, ",", pid.ToString());
                //            break;
                //    }
                //}
