...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("					<p id=\"divPollItem\"><a onclick=\"if(!delObj(document.getElementById('polloptions'),2,this.parentNode)){alert('投票项不能少于2个');}\" title=\"删除投票项\" class=\"del\" href=\"javascript:;\">del</a><input type=\"text\" id=\"pollitemid\" name=\"pollitemid\" class=\"txt\" style=\"width:340px;\"/></p>\r\n");
	templateBuilder.Append("					<p><a onclick=\"if(!delObj(document.getElementById('polloptions'),2,this.parentNode)){alert('投票项不能少于2个');}\" title=\"删除投票项\" class=\"del\" href=\"javascript:;\">del</a><input type=\"text\" id=\"pollitemid\" name=\"pollitemid\" class=\"txt\" style=\"width:340px;\"/></p>\r\n");
	templateBuilder.Append("				</div>\r\n");
	...
	templateBuilder.Append("					<span id=\"maxchoicescontrol\" style=\"display: none\">最多可选项数: <input type=\"text\" tabindex=\"1\" value=\"\" class=\"spshortinput txt\" name=\"maxchoices\" size=\"8\"/></span>\r\n");
	templateBuilder.Append("				</p>\r\n");
	templateBuilder.Append("				<p class=\"mbn\">\r\n");
	templateBuilder.Append("					<input name=\"createpoll\" type=\"hidden\" id=\"createpoll\" value=\"1\" />\r\n");
	templateBuilder.Append("					<input type=\"checkbox\" tabindex=\"1\" name=\"visiblepoll\"/>提交投票后结果才可见</p>\r\n");
	templateBuilder.Append("				<p class=\"mbn\"><input type=\"checkbox\" tabindex=\"1\" name=\"allowview\"/>公开投票参与人</p>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("		</div>\r\n");
	...
	templateBuilder.Append("					<dd><textarea tabindex=\"1\" class=\"txtarea\" id=\"positiveopinion\" name=\"positiveopinion\" style=\"width: 210px;\" ></textarea></dd>\r\n");
	templateBuilder.Append("					<dt><strong class=\"rq\">*</strong><label for=\"negapoint\">反方:</label></dt>				\r\n");
	templateBuilder.Append("					<dd><textarea tabindex=\"1\" class=\"txtarea\" id=\"negativeopinion\" name=\"negativeopinion\" style=\"width: 210px;\" ></textarea></dd>\r\n");
	templateBuilder.Append("				</dl>\r\n");
	templateBuilder.Append("			</div>\r\n");
