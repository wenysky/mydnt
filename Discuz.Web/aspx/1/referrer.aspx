...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("			推荐主题</strong>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("<script src=\"javascript/referrer.js\"></");
	templateBuilder.Append("script>\r\n");
	...
	templateBuilder.Append("	<div id=\"floatlayout_referrer\" class=\"float\" style=\"width: 600px; height: 410px;\">\r\n");

	}
	else
	{

	templateBuilder.Append("	<div id=\"floatlayout_referrer\" class=\"float\">\r\n");

	}	//end if

	templateBuilder.Append("	<h3 class=\"float_ctrl\">\r\n");
	templateBuilder.Append("		<em id=\"returnmessage\">推荐</em>\r\n");

	if (infloat==1)
	{

	templateBuilder.Append("			<span>\r\n");
	templateBuilder.Append("				<a id=\"creditlink\" href=\"javascript:;\"></a>\r\n");
	templateBuilder.Append("				<a title=\"关闭\" onclick=\"floatwin('close_referrer')\" class=\"float_close\" href=\"javascript:;\">关闭</a>\r\n");
	templateBuilder.Append("			</span>\r\n");
	...
	templateBuilder.Append("		<form method=\"post\" name=\"referrerform\" id=\"referrerform\" action=\"");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("		<form method=\"post\" name=\"postform\" id=\"postform\" action=\"\" enctype=\"multipart/form-data\" onsubmit=\"return validatereferrer();\">	\r\n");

	}	//end if

	templateBuilder.Append("		<input id=\"poster\" name=\"poster\" type=\"hidden\" class=\"txt\" />\r\n");
	templateBuilder.Append("		<input id=\"postdatetime\" name=\"postdatetime\" type=\"hidden\" class=\"txt\" />\r\n");
	templateBuilder.Append("		<input id=\"blockid\" name=\"blockid\" type=\"hidden\" class=\"txt\" value=\"1\"/>\r\n");
	templateBuilder.Append("		<div id=\"getPages\" style=\"display:none\">page1</div>\r\n");
	templateBuilder.Append("		<div class=\"float_referrer s_clear\">\r\n");
	templateBuilder.Append("			<label>区块名称:</label><input id=\"blockname\" name=\"blockname\" type=\"text\" class=\"txt\" value=\"\"/>\r\n");
	templateBuilder.Append("			<cite class=\"tips\"><a id=\"getblocks\" onclick=\"getlist('page')\">按页面选择区块</a></cite>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div id=\"getblocks_menu\" class=\"popupmenu_popup blocks\" style=\"display:none;\">\r\n");
	templateBuilder.Append("			<div class=\"close_blocks\">\r\n");
	templateBuilder.Append("				<a title=\"关闭\" onclick=\"close_getblocks_menu()\" class=\"float_close\" href=\"javascript:;\">关闭</a>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div id=\"pageslayer\"></div>\r\n");
	templateBuilder.Append("			<div id=\"blockslayer\" style=\"display:none;\"></div>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"float_referrer s_clear\">\r\n");
	templateBuilder.Append("			<label>区块标题:</label><input id=\"topicTitle\" name=\"topicTitle\" type=\"text\" class=\"txt\" value=\"");
	templateBuilder.Append(title.ToString());
	templateBuilder.Append("\"/>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"float_referrer s_clear\">\r\n");
	templateBuilder.Append("			<label>区块图片:</label><input id=\"selectImage\" name=\"selectImage\" type=\"text\" class=\"txt\" value=\"选择图片\"/><cite class=\"tips\"><a id=\"getimages\" onclick=\"getlist('image',");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append(")\">选择</a></cite>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div id=\"imageList\" class=\"float_referrer s_clear\" style=\"display:none;\">\r\n");
	templateBuilder.Append("			<div id=\"playlist\" class=\"playList\">\r\n");
	templateBuilder.Append("				<div class=\"plBd\" id=\"plBd\">\r\n");
	templateBuilder.Append("					<ul id='imagelistsider'>\r\n");
	templateBuilder.Append("					</ul>\r\n");
	templateBuilder.Append("				</div>\r\n");
	templateBuilder.Append("				<div class=\"next\"><a id=\"previous\" href=\"javascript:;\">下一页</a></div>\r\n");
	templateBuilder.Append("				<div class=\"previous\"><a id=\"next\" href=\"javascript:;\">上一页</a></div>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div id=\"largeimage\" style=\"display:none;\"></div>\r\n");
	templateBuilder.Append("		<script src=\"javascript/referrer_imagelist.js\"></");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("		<div class=\"float_referrer\"><label>区块内容:</label><textarea id=\"summary\" name=\"summary\"  class=\"txtarea\" cols=\"70\" rows=\"5\">");
	templateBuilder.Append(summary.ToString());
	templateBuilder.Append("</textarea></div>\r\n");
	templateBuilder.Append("		<div id=\"moreconf\" class=\"float_referrer\">\r\n");
	templateBuilder.Append("			<button name=\"add\" type=\"submit\" id=\"add\">确定</button>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("	</form>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("	</div>\r\n");
