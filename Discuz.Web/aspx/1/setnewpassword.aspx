...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <strong>密码重置</strong></div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("	<table cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\" summary=\"密码重置\">\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th><label for=\"newpassword\">新密码</label></th>\r\n");
	templateBuilder.Append("			<td>\r\n");
	templateBuilder.Append("				<input name=\"newpassword\" type=\"password\" id=\"newpassword\" size=\"25\" class=\"txt\"  />\r\n");
	...
	templateBuilder.Append("			<td><input name=\"confirmpassword\" type=\"password\" id=\"confirmpassword\" size=\"25\" class=\"txt\" ></td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	...
	templateBuilder.Append("			<td>\r\n");
	templateBuilder.Append("				<button name=\"login\" type=\"submit\" id=\"login\" onclick=\"javascript:location.replace('?agree=yes')\">确定</button>\r\n");
	templateBuilder.Append("				<button name=\"cancel\" type=\"button\" id=\"cancel\" onclick=\"javascript:location.replace('/')\">取消</button>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
