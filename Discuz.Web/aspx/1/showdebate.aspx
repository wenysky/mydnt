...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("			<div style=\"padding-left:15px;\">\r\n");
	...
	templateBuilder.Append("<span>开始时间 <em>\r\n");
	...
	templateBuilder.Append("			<a href=\"javascript:void(0)\" onclick=\"postToWb();\" id=\"k_weibo\"><i>转播到腾讯微博</i></a>\r\n");
	templateBuilder.Append("            <script type=\"text/javascript\">\r\n");
	templateBuilder.Append("                function postToWb() {\r\n");
	templateBuilder.Append("                    var _t = encodeURI(document.title);\r\n");
	templateBuilder.Append("                    var _url = encodeURIComponent(document.location);\r\n");
	templateBuilder.Append("                    var _appkey = encodeURI(\"982f7d6ff7684a7ea996704bd18b4d51\"); //你从腾讯获得的appkey\r\n");
	templateBuilder.Append("                    var _pic = encodeURI(''); //（例如：var_pic='图片url1|图片url2|图片url3....）\r\n");
	templateBuilder.Append("                    var _site = 'http://nt.discuz.net'; //你的网站地址\r\n");
	templateBuilder.Append("                    var _u = 'http://v.t.qq.com/share/share.php?title=' + _t + '&url=' + _url + '&appkey=' + _appkey + '&site=' + _site + '&pic=' + _pic;\r\n");
	templateBuilder.Append("                    window.open(_u, '', 'width=700, height=680, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, location=yes, resizable=no, status=no');\r\n");
	templateBuilder.Append("                }\r\n");
	templateBuilder.Append("            </");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("			</div>\r\n");
	...
	templateBuilder.Append("						<a href=\"###\" onClick=\"showMenu(this.id)\" id=\"commentdebates\" name=\"commentdebates\">点评</a><span class=\"pipe\">|</span>\r\n");
	...
	templateBuilder.Append("		</h1>\r\n");
	templateBuilder.Append("		<div class=\"debatebox cl\">\r\n");
	...
	templateBuilder.Append("										<span class=\"y\" style=\"font-size:12px;\">\r\n");
	...
	templateBuilder.Append("										</span>\r\n");
	templateBuilder.Append("										发表者:<a id=\"poster");
	templateBuilder.Append(positivepost.Pid.ToString().Trim());
	...
	templateBuilder.Append("								<div class=\"square cl\">\r\n");
	templateBuilder.Append("									<table cellspacing=\"0\" cellpadding=\"0\" summary=\"反方观点\">\r\n");
	templateBuilder.Append("									<tbody>\r\n");
	templateBuilder.Append("									<tr>\r\n");
	templateBuilder.Append("									<td class=\"supportbox\">\r\n");
	...
	templateBuilder.Append("										</span>发表者:<a id=\"poster");
	templateBuilder.Append(negativepost.Pid.ToString().Trim());
	templateBuilder.Append("\" href=\"");
