...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("	<div class=\"main\">\r\n");
	templateBuilder.Append("		<h3>界面</h3>\r\n");
	...
	templateBuilder.Append("			<img src=\"templates/" + template["directory"].ToString().Trim() + "/about.png\" />\r\n");
	templateBuilder.Append("			<p><input name=\"templateid\" type=\"radio\" value=\"" + template["templateid"].ToString().Trim() + "\" \r\n");
	...
	templateBuilder.Append("/>\r\n");
	templateBuilder.Append("			 " + template["name"].ToString().Trim() + "</p>\r\n");
	templateBuilder.Append("			</li>\r\n");

	}	//end loop

	templateBuilder.Append("		</ul>\r\n");
	templateBuilder.Append("		<div class=\"templatebutton cl\"><button type=\"submit\" name=\"Submit\" class=\"pn\"><span>确定</span></button></div>\r\n");
	templateBuilder.Append("		</form>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("	</div>\r\n");
