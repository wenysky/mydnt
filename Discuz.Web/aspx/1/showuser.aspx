...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:13:11.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:13:11. 
	*/
	...
	templateBuilder.Append("<div class=\"main datalist\">\r\n");
	...
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<span class=\"postbtn left\">\r\n");
	templateBuilder.Append("		<input type=\"text\" size=\"22\" id=\"username\" name=\"username\" class=\"txt\" onKeyDown=\"javascript:if(event.keyCode==13) window.location.href='userinfo.aspx?username='+this.value;\" />\r\n");
	templateBuilder.Append("		<button type=\"button\" onclick=\"if(document.getElementById('username').value==''){return false;}else{window.location.href='userinfo.aspx?username=' + document.getElementById('username').value;}\">查看用户</button>\r\n");
	templateBuilder.Append("		</span>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("	<table summary=\"用户列表\" cellspacing=\"0\" cellpadding=\"0\" class=\"datatable\">\r\n");
	...
	templateBuilder.Append("			<th class=\"datatitle\">\r\n");
	...
	templateBuilder.Append("			<td class=\"time\"><span title=\"\r\n");
	templateBuilder.Append(Convert.ToDateTime(user["joindate"].ToString().Trim()).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\">");
	...
	templateBuilder.Append("			<td class=\"time\"><span title=\"\r\n");
	templateBuilder.Append(Convert.ToDateTime(user["lastactivity"].ToString().Trim()).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\">");
	...
	templateBuilder.Append("	<div class=\"pages_btns cl\" style=\"margin-top:10px;\">\r\n");
	templateBuilder.Append("		<div class=\"pages\">\r\n");
	templateBuilder.Append("			<kbd>共");
	templateBuilder.Append(totalusers.ToString());
	templateBuilder.Append("名用户</kbd>");
	...
	templateBuilder.Append("				<input id=\"page\" type=\"hidden\" value=\"");
	...
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("				&nbsp;\r\n");
	templateBuilder.Append("				<button type=\"submit\" name=\"Submit\" onclick=\"document.getElementById('username').value='';this.form.submit();\">排序</button>\r\n");
	templateBuilder.Append("			</form>\r\n");
	templateBuilder.Append("		</span>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("</div>\r\n");
