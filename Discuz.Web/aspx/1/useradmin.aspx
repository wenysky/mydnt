...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("	<form id=\"moderate\" name=\"moderate\" method=\"post\" onsubmit=\"ajaxpost('moderate', 'return_mods', 'return_mods', 'onerror');return false;\" action=\"");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("		<div class=\"topicadminlow\" style=\"height:60px;\">\r\n");
	templateBuilder.Append("			<label for=\"operatedusername\">被操作用户</label>:\r\n");
	...
	templateBuilder.Append("		        <li class=\"wide\"><label><input type=\"radio\" value=\"0\" name=\"bantype\" \r\n");
	...
	templateBuilder.Append("                <li class=\"wide\"><label><input type=\"radio\" value=\"1\" name=\"bantype\" \r\n");
	...
	templateBuilder.Append("				<li class=\"wide\"><label><input type=\"radio\" value=\"2\" name=\"bantype\" \r\n");
	...
	templateBuilder.Append("		    </ul>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"topicadminlow\" style=\"clear:both;margin:8px 0;height:35px;\"><label for=\"banexpirynew\">过期日期</label>:");
	...
	templateBuilder.Append("            <button name=\"modsubmit\" value=\"true\" type=\"submit\" class=\"submit\">提交</button>\r\n");
	templateBuilder.Append("        </div>\r\n");
	templateBuilder.Append("        </div>\r\n");
	templateBuilder.Append("	</form>\r\n");
	templateBuilder.Append("	</div>\r\n");
	...
	templateBuilder.Append("            <h3 class=\"flb\">\r\n");
	templateBuilder.Append("				<span class=\"y\">\r\n");
	templateBuilder.Append("					<a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('mods')\" title=\"关闭\">关闭</a>\r\n");
	templateBuilder.Append("				</span>\r\n");
	templateBuilder.Append("				<em id=\"return_mods\">");
	templateBuilder.Append(operationtitle.ToString());
	templateBuilder.Append("</em>\r\n");
