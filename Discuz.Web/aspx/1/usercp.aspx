...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("\";\r\n");
	templateBuilder.Append("function getvalidpic(data)\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("var pic='';\r\n");
	templateBuilder.Append("if(parseInt(data)==1)\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("    pic = '<img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/data_valid.gif\"/>';\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("if(parseInt(data)==0)\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("    pic = '<img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/data_invalid.gif\"/>';\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("document.write(pic);\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("function tickthreadtype(data)\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("var str='';\r\n");
	templateBuilder.Append("  switch (parseInt(data)){\r\n");
	templateBuilder.Append("   case 0:\r\n");
	templateBuilder.Append("str='不允许';\r\n");
	templateBuilder.Append("   case 1:\r\n");
	templateBuilder.Append("str='允许本版内置顶';\r\n");
	templateBuilder.Append("   case 2:\r\n");
	templateBuilder.Append("str='允许分类内置顶';\r\n");
	templateBuilder.Append("    case 3:\r\n");
	templateBuilder.Append("str='执行任意置顶';\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("document.write(str);\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("function searchtype(data)\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("switch (parseInt(data)){\r\n");
	templateBuilder.Append("   case 0:\r\n");
	templateBuilder.Append("str='不允许';\r\n");
	templateBuilder.Append("   case 1:\r\n");
	templateBuilder.Append("str='允许搜索标题或全文';\r\n");
	templateBuilder.Append("   case 2:\r\n");
	templateBuilder.Append("str='仅允许搜索标题';\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("document.write(str);\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("</");
	...
	templateBuilder.Append("	<div class=\"uc_content cl\">\r\n");
	templateBuilder.Append("		<h1 class=\"u_t\">用户组&权限</h1>\r\n");
	...
	templateBuilder.Append("		<div class=\"cpuser cl\">\r\n");
	...
	templateBuilder.Append("			<ul class=\"cprate\">\r\n");
	...
	templateBuilder.Append("			</ul>				\r\n");
	templateBuilder.Append("			<ul class=\"cpinfo\">\r\n");
	templateBuilder.Append("				<li><label>总发帖数:</label>\r\n");
	...
	templateBuilder.Append("</li>\r\n");
	templateBuilder.Append("				<li><label>精华帖数:</label>\r\n");
	...
	templateBuilder.Append("				</li>\r\n");
	templateBuilder.Append("				<li><label>新短消息数:</label>\r\n");
	...
	templateBuilder.Append("				<script>\r\n");
	templateBuilder.Append("				document.write(");
	...
	templateBuilder.Append("</li>\r\n");
	templateBuilder.Append("				<li><label>新通知数:</label>\r\n");
	...
	templateBuilder.Append("			</ul>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"cpsignature cl\">\r\n");
	templateBuilder.Append("			<span>签名</span>:\r\n");
	...
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"limits_box datalist cl\">\r\n");
	templateBuilder.Append("			<div id=\"list_memcp_main_c\" style=\"float:left;font-size:14px;padding-right:15px;\">\r\n");
	templateBuilder.Append("				<h3>您的主用户组</h3>				\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div id=\"list_memcp_main\">\r\n");
	templateBuilder.Append("			<div class=\"channelinfo\">主用户组决定了您在本论坛拥有哪些权限，您可以通过查看权限详细了解它</div>\r\n");
	templateBuilder.Append("			<table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" class=\"datatable\">\r\n");
	templateBuilder.Append("				<thead class=\"colplural\">\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<td width=\"13%\"/>\r\n");
	templateBuilder.Append("					<td width=\"11%\">用户级别</td>\r\n");
	templateBuilder.Append("					<td width=\"15%\">类型</td>\r\n");
	templateBuilder.Append("					<td width=\"20%\">积分起点</td>\r\n");
	templateBuilder.Append("					<td width=\"10%\">阅读权限</td>\r\n");
	templateBuilder.Append("					<td width=\"10%\">到期时间</td>\r\n");
	templateBuilder.Append("					<td>操作</td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				</thead>\r\n");
	templateBuilder.Append("				<tbody>\r\n");
	templateBuilder.Append("					<tr>\r\n");
	templateBuilder.Append("					<td><strong><u>");
	...
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("					</td>\r\n");
	templateBuilder.Append("					<td>（会员用户组）</td>\r\n");
	templateBuilder.Append("					<td>");
	...
	templateBuilder.Append("					<td>\r\n");
	templateBuilder.Append("					<a class=\"xg2\" href=\"###\" onclick=\"javascript:if ($('usergroupbox').style.display=='none')\r\n");
	templateBuilder.Append("					{\r\n");
	templateBuilder.Append("					$('usergroupbox').style.display='';\r\n");
	templateBuilder.Append("					}\r\n");
	templateBuilder.Append("					else\r\n");
	templateBuilder.Append("					{\r\n");
	templateBuilder.Append("					$('usergroupbox').style.display='none';\r\n");
	templateBuilder.Append("					}\">查看权限</a>\r\n");
	templateBuilder.Append("					</td>\r\n");
	templateBuilder.Append("					</tr>\r\n");
	templateBuilder.Append("				</tbody>\r\n");
	...
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("    	<div class=\"limits_box cl\" id=\"usergroupbox\" style=\"display:none;\">\r\n");

	if (useradminid>0)
	{

	templateBuilder.Append("			<div class=\"c_header\" id=\"list_admin_c\">\r\n");
	templateBuilder.Append("				<h3 onclick=\"toggle_collapse('list_admin', 1, 1);\">管理权限</h3>\r\n");
	templateBuilder.Append("				<div class=\"c_header_action\"><p onclick=\"toggle_collapse('list_admin', 1, 1);\" class=\"c_header_ctrlbtn\">[ 展开 ]</p></div>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div id=\"list_admin\">\r\n");
	templateBuilder.Append("			<table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" class=\"datatable\" >\r\n");
	templateBuilder.Append("			<tbody>\r\n");
	templateBuilder.Append("			<tr class=\"colplural\">\r\n");
	templateBuilder.Append("				<th>允许编辑帖子</th>\r\n");
	templateBuilder.Append("				<th>允许编辑投票</th>\r\n");
	templateBuilder.Append("				<th>允许删除帖子</th>\r\n");
	templateBuilder.Append("				<th>允许批量删除</th>\r\n");
	templateBuilder.Append("				<th>允许编辑用户</th>\r\n");
	templateBuilder.Append("				<th>允许查看论坛运行记录</th>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				<td><script type=\"text/javascript\">getvalidpic(");
	...
	templateBuilder.Append("			<tbody>\r\n");
	templateBuilder.Append("			<tr class=\"colplural\">\r\n");
	templateBuilder.Append("				<th>允许查看用户实名</th>\r\n");
	templateBuilder.Append("				<th>允许禁止用户</th>\r\n");
	templateBuilder.Append("				<th>允许禁止IP</th>\r\n");
	templateBuilder.Append("				<th>是否允许置顶</th>\r\n");
	templateBuilder.Append("				<th>允许查看IP</th>\r\n");
	templateBuilder.Append("				<th>发帖不受审核、过滤、灌水等限制</th>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				<td><script type=\"text/javascript\">getvalidpic(");
	...
	templateBuilder.Append(")</");
	templateBuilder.Append("script></td>\r\n");
	templateBuilder.Append("				<td><script type=\"text/javascript\">tickthreadtype(");
	...
	templateBuilder.Append("			<div class=\"c_header\" id=\"list_basic_c\">\r\n");
	templateBuilder.Append("				<h3 onclick=\"toggle_collapse('list_basic', 1, 1);\">基本权限</h3>\r\n");
	templateBuilder.Append("				<div class=\"c_header_action\"><p onclick=\"toggle_collapse('list_basic', 1, 1);\" class=\"c_header_ctrlbtn\">[ 展开 ]</p></div>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<table cellspacing=\"0\" cellpadding=\"0\" id=\"list_basic\" width=\"100%\" class=\"datatable\" >\r\n");
	templateBuilder.Append("			<tbody>\r\n");
	templateBuilder.Append("			<tr class=\"colplural\">\r\n");
	templateBuilder.Append("				<th>访问论坛</th>\r\n");
	templateBuilder.Append("				<th>阅读权限</th>\r\n");
	templateBuilder.Append("				<th>查看用户资料</th>							\r\n");
	templateBuilder.Append("				<th>使用搜索</th>								\r\n");
	templateBuilder.Append("				<th>短信收件箱容量</th>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				<td><script type=\"text/javascript\">getvalidpic(");
	...
	templateBuilder.Append(")</");
	templateBuilder.Append("script></td>\r\n");
	templateBuilder.Append("				<td><script type=\"text/javascript\">searchtype(");
	...
	templateBuilder.Append("			</tbody>\r\n");
	templateBuilder.Append("			</table>\r\n");
	templateBuilder.Append("			<div class=\"c_header\" id=\"list_post_c\">\r\n");
	templateBuilder.Append("				<h3 onclick=\"toggle_collapse('list_post', 1, 1);\">帖子相关</h3>\r\n");
	templateBuilder.Append("				<div class=\"c_header_action\"><p onclick=\"toggle_collapse('list_post', 1, 1);\" class=\"c_header_ctrlbtn\">[ 展开 ]</p></div>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div id=\"list_post\">\r\n");
	templateBuilder.Append("			<table cellspacing=\"0\" cellpadding=\"0\"  width=\"100%\" class=\"datatable\" >\r\n");
	templateBuilder.Append("			<tbody>\r\n");
	templateBuilder.Append("			<tr class=\"colplural\">\r\n");
	templateBuilder.Append("				<th>发新话题</th>\r\n");
	templateBuilder.Append("				<th>发表回复</th>\r\n");
	templateBuilder.Append("				<th>发起投票</th>\r\n");
	templateBuilder.Append("				<th>参与投票</th>\r\n");
	templateBuilder.Append("				<th>发表悬赏</th>\r\n");
	templateBuilder.Append("				<th>发表辩论</th>\r\n");
	templateBuilder.Append("				<th>发表交易</th>								\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				<td><script type=\"text/javascript\">getvalidpic(");
	...
	templateBuilder.Append("			  <tbody>\r\n");
	templateBuilder.Append("				<tr class=\"colplural\">\r\n");
	templateBuilder.Append("				  <th>最大签名长度</th>\r\n");
	templateBuilder.Append("				  <th>签名中使用 Discuz! 代码</th>\r\n");
	templateBuilder.Append("				  <th>签名中使用 [img] 代码</th>\r\n");
	templateBuilder.Append("				  <th>是否允许HTML帖</th>\r\n");
	templateBuilder.Append("				  <th>是否允许使用hide代码</th>\r\n");
	templateBuilder.Append("				  <th>主题最高售价</th>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("				  <td>");
	...
	templateBuilder.Append("			</table>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div class=\"c_header\" id=\"list_attachment_c\">\r\n");
	templateBuilder.Append("				<h3 onclick=\"toggle_collapse('list_attachment', 1, 1);\">附件相关</h3>\r\n");
	templateBuilder.Append("				<div class=\"c_header_action\"><p onclick=\"toggle_collapse('list_attachment', 1, 1);\" class=\"c_header_ctrlbtn\">[ 展开 ]</p></div>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div id=\"list_post cl\">\r\n");
	templateBuilder.Append("			<table cellspacing=\"0\" cellpadding=\"0\" id=\"list_attachment\" width=\"100%\" class=\"datatable\" >\r\n");
	templateBuilder.Append("			<tbody>\r\n");
	templateBuilder.Append("			<tr class=\"colplural\">\r\n");
	templateBuilder.Append("				<th>下载/查看附件</th>\r\n");
	templateBuilder.Append("				<th>发布附件</th>\r\n");
	templateBuilder.Append("				<th>设置附件权限</th>\r\n");
	templateBuilder.Append("				<th>单个最大附件尺寸</th>\r\n");
	templateBuilder.Append("				<th>每天最大附件总尺寸</th>\r\n");
	templateBuilder.Append("				<th>附件类型</th>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				<td><script type=\"text/javascript\">getvalidpic(");
