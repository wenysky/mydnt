...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("		<h1>转账与兑换记录</h1>\r\n");
	...
	templateBuilder.Append("			<th width=\"15%\">来自/到</th>\r\n");
	templateBuilder.Append("			<th width=\"20%\">时间</th>\r\n");
	templateBuilder.Append("			<th width=\"20%\">支出</th>\r\n");
	templateBuilder.Append("			<th width=\"20%\">收入</th>\r\n");
	...
	templateBuilder.Append("			<td class=\"time\">" + creditslog["paydate"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>");
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("			<td>" + creditslog["operationinfo"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	...
	templateBuilder.Append("		<div class=\"zerothreads\">暂无记录</div>\r\n");
