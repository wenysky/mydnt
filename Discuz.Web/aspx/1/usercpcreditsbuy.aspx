...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:13:13.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:13:13. 
	*/
	...
	templateBuilder.Append("		<h1>积分充值</h1>\r\n");
	...
	templateBuilder.Append("	    <script type=\"text/javascript\" reload=\"1\">\r\n");
	templateBuilder.Append("	        function RedirectPayPage() {\r\n");
	templateBuilder.Append("	            var paytype = $('paytype').value;\r\n");
	templateBuilder.Append("	            var amount = $('paycredits').value;\r\n");
	templateBuilder.Append("	            if (amount == '') {\r\n");
	templateBuilder.Append("	                alert('您还没有填写需要充值的积分数量');\r\n");
	templateBuilder.Append("	                return false;\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("	            if(isNaN(amount)){\r\n");
	templateBuilder.Append("	                alert('请输入正确的数值');\r\n");
	templateBuilder.Append("	                return false;\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("	            if (paytype == '') {\r\n");
	templateBuilder.Append("	                alert('您还没有选择充值平台');\r\n");
	templateBuilder.Append("	                return false;\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("	            if(amount<");
	templateBuilder.Append(config.Mincreditstobuy.ToString().Trim());
	templateBuilder.Append("){\r\n");
	templateBuilder.Append("	                alert('您购买的积分数超过了系统要求的最低数量，无法购买');\r\n");
	templateBuilder.Append("	                return false;\r\n");
	templateBuilder.Append("	            }\r\n");
	...
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	templateBuilder.Append("){\r\n");
	templateBuilder.Append("	                alert('您购买的积分数超过了系统要求的最高数量，无法购买');\r\n");
	templateBuilder.Append("	                return false;\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("	            if(amount%1!=0){\r\n");
	templateBuilder.Append("	                alert('购买的积分数必须是整数');\r\n");
	templateBuilder.Append("	                return false;\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("	            if(!is_ie){\r\n");
	templateBuilder.Append("	                alert('由于您使用的浏览器为非IE浏览器，所以可能造成支付失败，请最好使用IE浏览器');\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("//	            amount=amount-(amount%1);\r\n");
	templateBuilder.Append("	            window.location.href = \"usercpcreditsbuy.aspx?redirect=\" + paytype + \"&amount=\" + amount;\r\n");
	templateBuilder.Append("	        }\r\n");
	templateBuilder.Append("	        function ShowPayRMB() {\r\n");
	templateBuilder.Append("	            var amount = $('paycredits').value;\r\n");
	templateBuilder.Append("	            if(isNaN(amount)){\r\n");
	templateBuilder.Append("	                $('rmbmsg').style.color = '#FF0000';\r\n");
	templateBuilder.Append("	                $('rmbmsg').innerHTML = '请输入正确的数值';\r\n");
	templateBuilder.Append("	                return false;\r\n");
	templateBuilder.Append("	            }	                \r\n");
	templateBuilder.Append("	            if(amount!=''){\r\n");
	templateBuilder.Append("	                var result = amount/");
	templateBuilder.Append(config.Cashtocreditrate.ToString().Trim());
	templateBuilder.Append(";\r\n");
	templateBuilder.Append("	                if(amount%1!=0){\r\n");
	templateBuilder.Append("	                    $('rmbmsg').style.color = '#FF0000';\r\n");
	templateBuilder.Append("	                    $('rmbmsg').innerHTML = '购买的积分数必须是整数';\r\n");
	templateBuilder.Append("	                }\r\n");
	templateBuilder.Append("	                else if(amount<");
	templateBuilder.Append(config.Mincreditstobuy.ToString().Trim());
	templateBuilder.Append("){\r\n");
	templateBuilder.Append("	                    $('rmbmsg').style.color = '#FF0000';\r\n");
	templateBuilder.Append("	                    $('rmbmsg').innerHTML = '系统规定您至少应购买");
	templateBuilder.Append(config.Mincreditstobuy.ToString().Trim());
	templateBuilder.Append("个积分';\r\n");
	templateBuilder.Append("	                }\r\n");
	templateBuilder.Append("	                else if(");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	templateBuilder.Append(">0&&amount>");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	templateBuilder.Append("){\r\n");
	templateBuilder.Append("	                     $('rmbmsg').style.color = '#FF0000';\r\n");
	templateBuilder.Append("	                     $('rmbmsg').innerHTML = '系统规定您至多可以购买");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	templateBuilder.Append("个积分';\r\n");
	templateBuilder.Append("	                }\r\n");
	templateBuilder.Append("	                else{\r\n");
	templateBuilder.Append("	                    $('rmbmsg').style.color = '#000000';\r\n");
	templateBuilder.Append("	                    $('rmbmsg').innerHTML = '需要支付 ￥'+ Math.round((Math.floor(result*1000)/10))/100 + '元';\r\n");
	templateBuilder.Append("	                }\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("	            else{\r\n");
	templateBuilder.Append("	                $('rmbmsg').innerHTML = '';\r\n");
	templateBuilder.Append("	            }\r\n");
	templateBuilder.Append("	        }\r\n");
	templateBuilder.Append("	    </");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("        <table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"积分充值\">\r\n");
	templateBuilder.Append("            <caption>\r\n");
	templateBuilder.Append("                <div class=\"hintinfo\" style=\"margin:0;\">您可以通过充值论坛积分享受论坛的增值体验</div>\r\n");
	templateBuilder.Append("            </caption>\r\n");
	templateBuilder.Append("            <tbody>\r\n");
	templateBuilder.Append("                <tr>\r\n");
	templateBuilder.Append("	                <th>积分充值</th>\r\n");
	...
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("                <tr>\r\n");
	templateBuilder.Append("	                <th>选择支付平台</th>\r\n");
	templateBuilder.Append("	                <td>\r\n");
	templateBuilder.Append("		                <input id=\"paytype\" type=\"hidden\" value=\"alipay\" />\r\n");
	templateBuilder.Append("		                <input id=\"paytype1\" name=\"paytype\" value=\"alipay\" type=\"radio\" checked=\"checked\" onclick=\"$('paytype').value=this.value;\" style=\" margin-top:-3px;\"/><img src=\"");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("		                <button type=\"button\" class=\"pn\" onclick=\"RedirectPayPage();\"><span>点击充值</span></button>\r\n");
	templateBuilder.Append("	                </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("            </tbody>\r\n");
