...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("		<table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"积分兑换\">\r\n");
	templateBuilder.Append("			<caption>\r\n");
	templateBuilder.Append("				<div class=\"hintinfo\" style=\"margin:0;\">积分交易税 ");
	...
	templateBuilder.Append("				<th>当前帐户</th>\r\n");
	...
	templateBuilder.Append("				<td><span class=\"z\">将数量<input name=\"paynum\" type=\"text\" id=\"paynum\" value=\"100\" size=\"10\" class=\"txt\"/>&nbsp;的&nbsp;</span>\r\n");
	templateBuilder.Append("					<div class=\"ftid\">\r\n");
	templateBuilder.Append("						<select name=\"extcredits1\" id=\"extcredits1\">\r\n");
	...
	templateBuilder.Append("						</select>\r\n");
	templateBuilder.Append("					</div>\r\n");
	templateBuilder.Append("					<script type=\"text/javascript\">simulateSelect('extcredits1');</");
	templateBuilder.Append("script>	\r\n");
	templateBuilder.Append("					<span class=\"z\">转换为&nbsp;</span>				\r\n");
	templateBuilder.Append("					<div class=\"ftid\">\r\n");
	templateBuilder.Append("						<select name=\"extcredits2\" id=\"extcredits2\">\r\n");
	...
	templateBuilder.Append("						</select>\r\n");
	templateBuilder.Append("					</div>\r\n");
	templateBuilder.Append("					<script type=\"text/javascript\">simulateSelect('extcredits2');</");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("					<span class=\"z\"><a href=\"###\" onclick=\"if($('postform').extcredits1.options[$('postform').extcredits1.selectedIndex].value != 0 && $('postform').extcredits2.options[$('postform').extcredits2.selectedIndex].value != 0){alert('接收者的所得为 '+$('postform').extcredits2.options[$('postform').extcredits2.selectedIndex].text + ':'+Math.round($('postform').paynum.value*(creditsrate[$('postform').extcredits1.options[$('postform').extcredits1.selectedIndex].value]/creditsrate[$('postform').extcredits2.options[$('postform').extcredits2.selectedIndex].value] *(1-");
	templateBuilder.Append(creditstax.ToString());
	...
	templateBuilder.Append("					<button type=\"submit\" name=\"Submit\" class=\"pn\"><span>确定</span></button>\r\n");
	templateBuilder.Append("				</td>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			</tbody>\r\n");
