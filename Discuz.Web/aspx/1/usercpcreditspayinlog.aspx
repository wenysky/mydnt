...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("		<h1>积分收入记录</h1>\r\n");
	...
	templateBuilder.Append("			<th width=\"10%\">发表时间</th>\r\n");
	...
	templateBuilder.Append("			<th>作者所得</th>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td class=\"time\">" + paylog["postdatetime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td class=\"time\">" + paylog["buydate"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + paylog["amount"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + paylog["netamount"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
