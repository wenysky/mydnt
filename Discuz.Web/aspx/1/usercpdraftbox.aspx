...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("		<h1>草稿箱</h1>\r\n");
	...
	templateBuilder.Append("				<table cellspacing=\"0\" cellpadding=\"0\" class=\"pm_list\" summary=\"草稿箱\">\r\n");
	...
	templateBuilder.Append("					<tr id=\"pm.pmid\">\r\n");
	...
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\">\r\n");
	templateBuilder.Append(Utils.GetUnicodeSubString(pm.Message,40,"..."));
	templateBuilder.Append("</a>\r\n");
	templateBuilder.Append("								</div>\r\n");
	templateBuilder.Append("							</div>\r\n");
	templateBuilder.Append("						</td>\r\n");
	templateBuilder.Append("						<td class=\"delete_msg\"><a href=\"###\" onclick=\"if (confirm('您确定要删除吗?')){ $('id");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	...
	templateBuilder.Append("				    <div class=\"zerothreads\">草稿箱暂无短信息</div>\r\n");
