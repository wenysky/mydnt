...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("<div class=\"wrap c1 pageinfo\">\r\n");
	...
	templateBuilder.Append("		<h1>黑名单</h1>\r\n");
	...
	templateBuilder.Append("			<form id=\"postignorelist\" name=\"postignorelist\" method=\"post\" action=\"\">\r\n");
	templateBuilder.Append("			<table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"个人资料\">\r\n");
	templateBuilder.Append("				<caption>\r\n");
	templateBuilder.Append("					如果某用户被加入到黑名单中，那么该用户给您发送的短消息将不会被接收。<br />\r\n");
	templateBuilder.Append("					将多个用户添加到黑名单时需要用逗号(英文半角)分割，如“张三,李四,王五”。<br />\r\n");
	templateBuilder.Append("					如需禁止接受所有用户发来的短消息，请设置为 \"");
	...
	templateBuilder.Append("					<textarea name=\"ignorepm\" class=\"txtarea\" cols=\"40\" rows=\"10\" id=\"ignorepm\" onkeydown=\"if((event.ctrlKey && event.keyCode == 13) || (event.altKey && event.keyCode == 83)) document.getElementById('postignorelist').submit();\" style=\"width:80%;\">");
	templateBuilder.Append(user.Ignorepm.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n");
	templateBuilder.Append("					</td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<td><input name=\"sendignorelist\" type=\"submit\" id=\"sendignorelist\" value=\"保存\" class=\"btn\"/></td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				</tbody>\r\n");
