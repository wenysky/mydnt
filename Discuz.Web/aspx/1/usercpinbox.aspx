...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:13:03.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:13:03. 
	*/
	...
	templateBuilder.Append("		<h1>收件箱</h1>\r\n");
	...
	templateBuilder.Append("		<table cellspacing=\"0\" cellpadding=\"0\" class=\"pm_list\" summary=\"收件箱\" width=\"100%\">\r\n");
	...
	templateBuilder.Append("			<tr id=\"");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\">\r\n");
	templateBuilder.Append("				<td class=\"msg_icon\"><img src=\"");
	templateBuilder.Append(imagedir.ToString());
	...
	templateBuilder.Append("				<td class=\"checkbox_toggle\"><input name=\"pmitemid\" id=\"id");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\" type=\"checkbox\" value=\"");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\" style=\"margin-top:2px;\"/></td>\r\n");
	templateBuilder.Append("				<td class=\"profile_pic\">\r\n");
	...
	templateBuilder.Append("					<img width=\"48\" onerror=\"this.onerror=null;this.src='");
	templateBuilder.Append(imagedir.ToString());
	...
	templateBuilder.Append("				</td>\r\n");
	templateBuilder.Append("				<td class=\"name_and_date\">\r\n");
	templateBuilder.Append("					<span class=\"name xg2\">\r\n");
	 aspxrewriteurl = this.UserInfoAspxRewrite(pm.Msgfromid);
	...
	templateBuilder.Append("					<span class=\"date\">");
	templateBuilder.Append(postdatetime.ToString());
	templateBuilder.Append("</span></td>\r\n");
	templateBuilder.Append("				<td class=\"pmsubject\">\r\n");
	templateBuilder.Append("					<div class=\"subject_wrap xg2\">\r\n");
	templateBuilder.Append("						<p \r\n");
	...
	templateBuilder.Append("						<div class=\"snippet_wrap xg1\">\r\n");
	templateBuilder.Append("							<a href=\"usercpshowpm.aspx?pmid=");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\">\r\n");
	templateBuilder.Append(Utils.GetUnicodeSubString(Utils.RemoveHtml(pm.Message),40,"..."));
	templateBuilder.Append("</a>\r\n");
	templateBuilder.Append("						</div>\r\n");
	templateBuilder.Append("					</div>\r\n");
	templateBuilder.Append("				</td>\r\n");
	templateBuilder.Append("				<td class=\"delete_msg\"><a href=\"javascript:;\" onclick=\"if (confirm('您确定要删除吗?')){ $('id");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	...
	templateBuilder.Append("					<em>共有短消息:");
	...
	templateBuilder.Append("				</div>\r\n");
	templateBuilder.Append("				<a href=\"###\"  onclick=\"checkCheckBox($('pmform'),this)\">全选</a>\r\n");
	templateBuilder.Append("				<span class=\"pipe\">|</span>\r\n");
	templateBuilder.Append("				<a href=\"###\" onclick=\"if (confirm('您确定要删除吗?'))$('pmform').submit();\">删除</a>\r\n");
	templateBuilder.Append("			</div>\r\n");
	...
	templateBuilder.Append("			<div class=\"zerothreads\">收件箱暂无短信息</div>\r\n");
