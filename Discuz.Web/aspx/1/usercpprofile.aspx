...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:12:54.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:12:54. 
	*/
	...
	templateBuilder.Append("		    <div id=\"avatarchange\">\r\n");
	templateBuilder.Append("			    <h1 class=\"u_t\">设置头像</h1>\r\n");
	templateBuilder.Append("			    <input name=\"avatarchanged\" type=\"hidden\" value=\"0\" id=\"avatarchanged\" />\r\n");
	templateBuilder.Append("			    <table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"设置头像\">\r\n");
	templateBuilder.Append("			    <caption>\r\n");
	templateBuilder.Append("				    <h2 class=\"xs2\">当前我的头像</h2>\r\n");
	templateBuilder.Append("				    <p>如果你还没有设置自己的头像，系统会显示为默认头像，你需要自己上传一张新照片来作为自己的个人头像。</p>\r\n");
	templateBuilder.Append("			    </caption>\r\n");
	templateBuilder.Append("			    <tbody>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <td>				\r\n");
	templateBuilder.Append("                        <img id=\"avatar\" src=\"images/common/none.gif\" onerror=\"this.onerror=null;this.src='");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/noavatar_big.gif';\" />\r\n");
	templateBuilder.Append("			       </td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    </tbody>\r\n");
	templateBuilder.Append("			    </table>\r\n");
	templateBuilder.Append("			    <table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\">\r\n");
	templateBuilder.Append("			    <caption>\r\n");
	templateBuilder.Append("				    <h2 class=\"xs2\">设置我的新头像</h2>\r\n");
	templateBuilder.Append("				    <p>请选择一个新照片进行上传编辑。头像保存后，你可能需要刷新一下本页面(按F5键)，才能查看最新的头像效果。可以选择以\"Flash头像\"和\"超级银光头像\"两种方式上传。</p>\r\n");
	templateBuilder.Append("			    </caption>\r\n");
	templateBuilder.Append("			    <tbody>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <td>\r\n");
	templateBuilder.Append("					    <p class=\"sel_avt cl\"><a href=\"javascript:;\" onclick=\"$('avatarctrl').style.display = '';$('avatarSilverlight').style.display = 'none';\">Flash头像</a>\r\n");
	templateBuilder.Append("					    <a href=\"#/MainPage\" onclick=\"$('avatarSilverlight').style.display = '';$('avatarctrl').style.display = 'none';\">超级银光头像</a></p>\r\n");
	templateBuilder.Append("					    <div id=\"avatarctrl\">\r\n");
	templateBuilder.Append("					    <script type=\"text/javascript\">                     \r\n");
	templateBuilder.Append("						    document.write(AC_FL_RunContent('width', '540', 'height', '253', 'scale', 'exactfit', 'src', '");
	...
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("					    </div>\r\n");
	templateBuilder.Append("					    <div id=\"avatarSilverlight\" style=\"clear:both;display:none; width:520px;height:300px;\">\r\n");
	...
	templateBuilder.Append("script>               \r\n");
	templateBuilder.Append("					    <div id=\"silverlightControlHost\" style=\"width:520px;height:300px;\">\r\n");
	templateBuilder.Append("						    <object  id=\"avatarUpload\" data=\"data:application/x-silverlight-2,\" type=\"application/x-silverlight-2\" width=\"520px\" height=\"300px\">\r\n");
	...
	templateBuilder.Append("						      <param name=\"background\" value=\"white\" />\r\n");
	...
	templateBuilder.Append("						      <param name=\"initParams\" value=\"authToken=");
	...
	templateBuilder.Append("							    $(\"avatarUpload\").content.JavaScriptObject.CloseAvatar = updateavatar;//注册js方法以便silverlight调用\r\n");
	templateBuilder.Append("					       }                  \r\n");
	templateBuilder.Append("					    </");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("					    </div>\r\n");
	templateBuilder.Append("					    <script type=\"text/javascript\">\r\n");
	templateBuilder.Append("					    function updateavatar(sender, args) {\r\n");
	templateBuilder.Append("					       $('avatar').src = '");
	templateBuilder.Append(avatarImage.ToString());
	templateBuilder.Append("?random=1' + Math.random();\r\n");
	templateBuilder.Append("					       $('avatarSilverlight').style.display = 'none';                      \r\n");
	templateBuilder.Append("					    }\r\n");
	templateBuilder.Append("					    updateavatar();\r\n");
	templateBuilder.Append("					    </");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("			       </td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	...
	templateBuilder.Append("		    <div id=\"u_cp\">\r\n");
	templateBuilder.Append("		    <h1>个人资料</h1>\r\n");
	...
	templateBuilder.Append("        <li id=\"u_cpfile_li\"><a href=\"usercpprofile.aspx?action=cpfile\">基本资料</a></li>\r\n");
	templateBuilder.Append("	    <li id=\"u_contact_li\"><a href=\"usercpprofile.aspx?action=contact\">联系方式</a></li>\r\n");
	templateBuilder.Append("	    <li id=\"u_signature_li\"><a href=\"usercpprofile.aspx?action=signature\">签名</a></li>\r\n");

	}
	else
	{

	templateBuilder.Append("	    <li id=\"u_cpfile_li\"><a href=\"javascript:void(0);\" onclick=\"ShowPanel('u_cpfile');\">基本资料</a></li>\r\n");
	templateBuilder.Append("	    <li id=\"u_contact_li\"><a href=\"javascript:void(0);\" onclick=\"ShowPanel('u_contact');\">联系方式</a></li>\r\n");
	templateBuilder.Append("	    <li id=\"u_signature_li\"><a href=\"javascript:void(0);\" onclick=\"ShowPanel('u_signature');\">签名</a></li>\r\n");
	...
	templateBuilder.Append("		    <table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"个人资料\">\r\n");
	templateBuilder.Append("		    <tbody id=\"u_cpfile\">\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>真实姓名</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"realname\" type=\"text\" id=\"realname\" value=\"");
	...
	templateBuilder.Append("							<select name=\"gender\" id=\"gender\">\r\n");
	...
	templateBuilder.Append("							</select>\r\n");
	templateBuilder.Append("						</div>\r\n");
	templateBuilder.Append("						<script type=\"text/javascript\">simulateSelect('gender');</");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("				    </td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	...
	templateBuilder.Append("				    <td>\r\n");
	templateBuilder.Append("					    <input name=\"bday\" type=\"text\"  class=\"txt\" id=\"bday\" size=\"10\" value=\"");
	...
	templateBuilder.Append("				    <td>\r\n");
	templateBuilder.Append("					    <input name=\"location\" type=\"text\" class=\"txt\" id=\"location\" class=\"colorblue\" value=\"");
	...
	templateBuilder.Append("				    <td>\r\n");
	templateBuilder.Append("					    <input name=\"idcard\" type=\"text\" id=\"idcard\" value=\"");
	...
	templateBuilder.Append("				    <td><input type=\"text\" class=\"txt\" size=\"25\" id=\"nickname\" name=\"nickname\" value=\"");
	...
	templateBuilder.Append("				    <td>\r\n");
	templateBuilder.Append("					    <textarea name=\"bio\" cols=\"50\" rows=\"4\" id=\"bio\" class=\"txtarea\" onclick=\"if (document.getElementById('bio').value.length > 500) {alert('自我介绍长度最大为500字'); return false;}\" >");
	templateBuilder.Append(user.Bio.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n");
	templateBuilder.Append("				    </td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("		    </tbody>\r\n");
	templateBuilder.Append("		    <tbody id=\"u_contact\">\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>移动电话号码</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"mobile\" type=\"text\"  class=\"txt\" id=\"mobile\" value=\"");
	templateBuilder.Append(user.Mobile.ToString().Trim());
	templateBuilder.Append("\" size=\"25\" /></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>固定电话号码</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"phone\" type=\"text\" id=\"phone\" value=\"");
	templateBuilder.Append(user.Phone.ToString().Trim());
	templateBuilder.Append("\" size=\"25\" class=\"txt\" /></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>EMail</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"email\" type=\"text\" id=\"email\" value=\"");
	...
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>主页</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"website\" type=\"text\" id=\"website\" value=\"");
	templateBuilder.Append(user.Website.ToString().Trim());
	templateBuilder.Append("\" size=\"25\" class=\"txt\"/></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>MSN Messenger</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"msn\" type=\"text\" id=\"msn\" value=\"");
	templateBuilder.Append(user.Msn.ToString().Trim());
	templateBuilder.Append("\" size=\"25\"  class=\"txt\"/></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>QQ</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"qq\" type=\"text\" id=\"qq\" value=\"");
	templateBuilder.Append(user.Qq.ToString().Trim());
	templateBuilder.Append("\" size=\"25\"  class=\"txt\"/></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>Skype</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"skype\" type=\"text\" id=\"skype\" value=\"");
	templateBuilder.Append(user.Skype.ToString().Trim());
	templateBuilder.Append("\" size=\"25\"  class=\"txt\"/></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>ICQ</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"icq\" type=\"text\" id=\"icq\" value=\"");
	templateBuilder.Append(user.Icq.ToString().Trim());
	templateBuilder.Append("\" size=\"25\"  class=\"txt\"/></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>Yahoo Messenger</th>\r\n");
	templateBuilder.Append("				    <td><input name=\"yahoo\" type=\"text\" id=\"yahoo\" value=\"");
	templateBuilder.Append(user.Yahoo.ToString().Trim());
	templateBuilder.Append("\" size=\"30\"  class=\"txt\"/></td>\r\n");
	templateBuilder.Append("			    </tr>\r\n");
	templateBuilder.Append("		    </tbody>\r\n");
	templateBuilder.Append("		    <tbody id=\"u_signature\">\r\n");
	templateBuilder.Append("			    <tr>\r\n");
	templateBuilder.Append("				    <th>签名</th>\r\n");
	templateBuilder.Append("				    <td>\r\n");
	templateBuilder.Append("                        <div id=\"signaturepreview\" style=\"display:none\" class=\"rulespreview\"></div>\r\n");
	...
	templateBuilder.Append("                                    <a id=\"viewsignature\" href=\"###\" onclick=\"preview('signaturepreview','signaturemessage')\">预览</a>		\r\n");
	...
	templateBuilder.Append("                                </div>\r\n");
	templateBuilder.Append("                        </div>\r\n");
	templateBuilder.Append("					    <textarea id=\"signaturemessage\" rows=\"4\" cols=\"50\" name=\"signature\" class=\"txtarea\" style=\"width:70%;padding:0;\">");
	templateBuilder.Append(user.Signature.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n");
	templateBuilder.Append("				    </td>\r\n");
	templateBuilder.Append("                    <td>\r\n");
	templateBuilder.Append("                        <p>Discuz!NT代码: \r\n");
	...
	templateBuilder.Append("				    <td><input name=\"sigstatus\" type=\"checkbox\" id=\"sigstatus\" value=\"1\" \r\n");
	...
	templateBuilder.Append("		    <tr>\r\n");
	templateBuilder.Append("			    <th> </th>\r\n");
	templateBuilder.Append("			    <td><button value=\"true\" id=\"editsubmit\" name=\"editsubmit\" type=\"submit\" class=\"pn\"><span>提交</span></button></td>\r\n");
	templateBuilder.Append("		    </tr>\r\n");
	templateBuilder.Append("		    </table>\r\n");
	templateBuilder.Append("		    </div>\r\n");
	templateBuilder.Append("		    <script type=\"text/javascript\">\r\n");
	templateBuilder.Append("		        function InitProfilePanel() {\r\n");
	templateBuilder.Append("		            $('u_cpfile').style.display = 'none';\r\n");
	templateBuilder.Append("		            $('u_contact').style.display = 'none';\r\n");
	templateBuilder.Append("		            $('u_signature').style.display = 'none';\r\n");
	templateBuilder.Append("		            $('u_cpfile_li').className = '';\r\n");
	templateBuilder.Append("		            $('u_contact_li').className = '';\r\n");
	templateBuilder.Append("		            $('u_signature_li').className = '';\r\n");
	templateBuilder.Append("		        }\r\n");
	templateBuilder.Append("		        function ShowPanel(id) {\r\n");
	templateBuilder.Append("		            InitProfilePanel();\r\n");
	templateBuilder.Append("		            $(id).style.display = '';\r\n");
	templateBuilder.Append("		            $(id + \"_li\").className = 'cur_tab';\r\n");
	templateBuilder.Append("		        }\r\n");
	templateBuilder.Append("		        var action = '");
	templateBuilder.Append(action.ToString());
	templateBuilder.Append("';\r\n");
	templateBuilder.Append("		        action = action == '' ? 'u_cpfile' : 'u_' + action;\r\n");
	templateBuilder.Append("		        ShowPanel(action);\r\n");
	templateBuilder.Append("		    </");
	templateBuilder.Append("script>\r\n");
