...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("		<h1>查看短消息</h1>\r\n");


	if (userid>0)
	{

	templateBuilder.Append("<div class=\"uc_header\">\r\n");
	templateBuilder.Append("	<a class=\"btn_uc\" onclick=\"floatwin('open_postpm', this.href, 600, 410, '600,0');doane(event);\" href=\"usercppostpm.aspx\">+ 写新消息</a>	\r\n");
	...
	templateBuilder.Append("<ul class=\"p_pop\" id=\"notice_menu\" style=\"display: none\">\r\n");
	...
	templateBuilder.Append("	<li><a href=\"usercpnotice.aspx?filter=topicadmin\">管理通知</a></li>\r\n");
	templateBuilder.Append("</ul>\r\n");
	...
	templateBuilder.Append("		<ul class=\"note\" style=\"margin:15px;\">\r\n");
	templateBuilder.Append("			<li class=\"f_bold\">");
	...
	templateBuilder.Append("			<li><cite>发送人:");
	templateBuilder.Append(msgfrom.ToString());
	templateBuilder.Append("</cite></li>\r\n");
	templateBuilder.Append("			<li></li>\r\n");
	templateBuilder.Append("			<li id=\"msg\">");
	templateBuilder.Append(message.ToString());
	templateBuilder.Append("</li>\r\n");
	templateBuilder.Append("		</ul>\r\n");
	templateBuilder.Append("		<script type=\"text/javascript\">\r\n");
	templateBuilder.Append("			$('msg').innerHTML = parseurl($('msg').innerHTML, 'html', false);\r\n");
	templateBuilder.Append("		</");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("		<div class=\"notefilter\">\r\n");
	templateBuilder.Append("			<a href=\"usercpinbox.aspx\">返回列表</a>\r\n");
	templateBuilder.Append("			<a href=\"usercppostpm.aspx?action=re&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\">回复</a>\r\n");
	templateBuilder.Append("			<a href=\"usercppostpm.aspx?action=fw&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\">转发</a>\r\n");
	templateBuilder.Append("			<a href=\"usercpshowpm.aspx?action=noread&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\">标记为未读</a>\r\n");
	templateBuilder.Append("			<a href=\"usercpshowpm.aspx?action=delete&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\"  onclick=\"if (confirm('您确定要删除吗?')){return true;}\">删除</a>\r\n");
	templateBuilder.Append("		</div>\r\n");

	if (canreplypm)
	{

	templateBuilder.Append("		<form id=\"postpm\" name=\"postpm\" method=\"post\" action=\"usercppostpm.aspx?action=re&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	...
	templateBuilder.Append("				<th>接件人</th>\r\n");
	templateBuilder.Append("				<td>\r\n");
	templateBuilder.Append("					<input name=\"msgto\" type=\"text\" id=\"msgto\" value=\"");
	...
	templateBuilder.Append("				<td>\r\n");
	templateBuilder.Append("					<input name=\"subject\" type=\"text\" id=\"subject\" value=\"");
	templateBuilder.Append(resubject.ToString());
	templateBuilder.Append("\" size=\"40\"  class=\"txt\"/>\r\n");
	templateBuilder.Append("				</td>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				<th>内容</th>\r\n");
	templateBuilder.Append("				<td>\r\n");
	templateBuilder.Append("					<textarea name=\"message\" cols=\"80\" rows=\"20\" id=\"message\" onkeydown=\"if((event.ctrlKey && event.keyCode == 13) || (event.altKey && event.keyCode == 83)) document.getElementById('postpm').submit();\" class=\"txtarea\">");
	...
	templateBuilder.Append("				<td>\r\n");
	templateBuilder.Append("					<input name=\"savetosentbox\" type=\"checkbox\" id=\"Checkbox1\" value=\"1\" />保存到发件箱\r\n");
	templateBuilder.Append("					<input type=\"checkbox\" name=\"emailnotify\" id=\"emailnotify\" />E-mail通知\r\n");
	templateBuilder.Append("				</td>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	...
	templateBuilder.Append("				<th> </th>\r\n");
	templateBuilder.Append("				<td>\r\n");
	templateBuilder.Append("					<input name=\"sendmsg\" type=\"submit\" id=\"sendmsg\" value=\"立即发送\" class=\"btn\"/>\r\n");
	templateBuilder.Append("					<input name=\"savetousercpdraftbox\" type=\"submit\" id=\"savetousercpdraftbox\" value=\"存为草稿\" class=\"btn\"/>\r\n");
	templateBuilder.Append("					[可按Ctrl+Enter提交]\r\n");
	templateBuilder.Append("				</td>\r\n");
	templateBuilder.Append("			</tr>\r\n");
	templateBuilder.Append("			</tbody>\r\n");
