...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/12/28 17:13:01.
		本页面代码由Discuz!NT模板引擎生成于 2010/12/28 17:13:01. 
	*/
	...
	templateBuilder.Append("<div class=\"wrap uc uc_info cl\">\r\n");
	templateBuilder.Append("	<div class=\"uc_app uc_side\">\r\n");
	...
	templateBuilder.Append("		<div class=\"itemtitle cl\">\r\n");
	...
	templateBuilder.Append("				<th width=\"150\">性别: </th>\r\n");
	...
	templateBuilder.Append("		<h3 class=\"blocktitle lightlink\">\r\n");
	templateBuilder.Append("		    用户组: ");
	...
	templateBuilder.Append("	                <span class=\"xg2\" style=\"font-size:12px\">过期时间: 永久</span>\r\n");
	...
	templateBuilder.Append("	                <span class=\"xg2\" style=\"font-size:12px\">过期时间: ");
	...
	templateBuilder.Append("			<ul style=\"width: 50%;\" class=\"commonlist y\">\r\n");
	...
	templateBuilder.Append("				<li><label>注册日期:</label>");
	...
	templateBuilder.Append("				<li><label>最后访问(登录):</label>");
	...
	templateBuilder.Append("				<li><label>最后活动:</label>");
	...
	templateBuilder.Append("				<li><label>注册 IP:</label>");
	...
	templateBuilder.Append("				<li><label>昵称:</label>");
	...
	templateBuilder.Append("				<li><label>自定义头衔:</label>");
	templateBuilder.Append(user.Customstatus.ToString().Trim());
	templateBuilder.Append("</li>\r\n");

	}	//end if

	templateBuilder.Append("				<li><label>阅读权限:</label>");
	templateBuilder.Append(group.Readaccess.ToString().Trim());
	templateBuilder.Append("</li>\r\n");
	templateBuilder.Append("				<li><label>发帖量:</label>");
