...
var optionCheckedTopics = function (option,reason) {
    ...
    _sendRequest('tools/ajax.aspx?t=' + option + 'topic&tid=' + tidlist + "&reason=" + reason, optionCheckedTopics_callback, false);
    }
}
...
var optionCheckedPosts = function (option, reason) {
    ...
    if (pidlist == "") {
        ...
        switch (option) {
            case "pass":
                _sendRequest('tools/ajax.aspx?t=passpost&pid=' + pidlist + "&reason=" + reason, optionCheckedPosts_callback, false);
                break;
            case "delete":
                _sendRequest('tools/ajax.aspx?t=deletepost&pid=' + pidlist + "&reason=" + reason, optionCheckedPosts_callback, false);
                break;
            case "ignore":
                _sendRequest('tools/ajax.aspx?t=ignorepost&pid=' + pidlist + "&reason=" + reason, optionCheckedPosts_callback, false);
                break;
        }
    }
}
...
function _auditpost(option, id, reason) {
    switch (option) {
        ...
        case "deletepost":
            ...
            _sendRequest('tools/ajax.aspx?t=' + option + '&pid=' + id + "&reason=" + reason, auditpost_callback, false);
            break;
        case "passtopic":
        case "ignoretopic":
        case "deletetopic":
            jQuery("#cite_" + id).hide();
            _sendRequest('tools/ajax.aspx?t=' + option + '&tid=' + id + "&reason=" + reason, audittopic_callback, false);
            break;
            break;
